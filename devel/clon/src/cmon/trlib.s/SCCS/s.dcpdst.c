...
c Name history : 1 0 clas/cmon/trlib.s/dcpdst.c
e
s 00074/00000/00000
...
void
dcpdst_(int *ntr_out,float ev_out[ntrmx][36], int *ntagh,float tag_res[10][7])
{
...
void
dcpdst(int ntr_out,float ev_out[ntrmx][36], int ntagh,float tag_res[10][7])
{
