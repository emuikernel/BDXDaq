h06399
s 00012/00000/01093
d D 1.3 06/09/01 00:34:05 boiarino 4 3
c dummy VXWORKS
c 
e
s 00110/00151/00983
d D 1.2 02/08/25 19:47:09 boiarino 3 1
c big cleanup (globals, locals, prototypes)
e
s 00000/00000/00000
d R 1.2 02/03/29 12:13:02 Codemgr 2 1
c SunPro Code Manager data about conflicts, renames, etc...
c Name history : 1 0 vxworks/level1/tigris/scintillator.c
e
s 01134/00000/00000
...
D 3
void             DrawScintItem();
static void      FixScintRegion();
static void      EditScintItem();
static void      EditScintColor();
void             DrawAllScintItems();
static void      ComputeScintPoints () ;

E 3
static Hv_Widget fillcolorlabel, framecolorlabel, hitcolorlabel;
D 3
static short     fillcolor, framecolor, hitcolor;
static int       WhichScint();
E 3
I 3
static short fillcolor, framecolor, hitcolor;
E 3
...
D 3
int              SDbits4sgl[6][2][96];
extern Hv_Item   ScintDFront16bits, ScintDBack32bits ;
E 3
I 3
...
/* -================================================-
  for (i=0; i<48; i++) {
    printf ("* %d * { %d %d %d }, { %d %d %d %d %d %d }\n", i,
	    bitslookup[i].b.howmany, 
	    bitslookup[i].b.litebitbut [0], 
	    bitslookup[i].b.litebitbut [1], 
	    bitslookup[i].howMany,
	    bitslookup[i].litBits [0], 
	    bitslookup[i].litBits [1], 
	    bitslookup[i].litBits [2], 
	    bitslookup[i].litBits [3], 
	    bitslookup[i].litBits [4]);
  }
* -==================================================- */
E 3
}
...
/* ============================================================= */
D 3
void frontBitsOff (sc, sd, pt, view)
int       sc, sd;
Hv_Point  pt[4];
Hv_View   view;
E 3
...
/* ============================================================= */
D 3
void frontBitsOn (sc,sd, pt, view)
int       sc, sd;
Hv_Point  pt[4];
Hv_View   view;
E 3
...
/* ============================================================= */
D 3
void boundBitsOff (sc, sd, pt, view)
int       sc, sd;
Hv_Point  pt[4];
Hv_View   view;
E 3
...
/* ============================================================= */
D 3
void boundBitsOn (sc, sd, pt, view)
int      sc, sd;
Hv_Point pt[4];
Hv_View  view;
E 3
...
/* ============================================================= */
D 3
void backBitsOff (sc, sd, pt, view)
int      sc, sd;
Hv_Point pt[4];
Hv_View  view;
E 3
...
/* ----------- LightScintillators ----------------- */
D 3
void LightScintillators (view, sc, sd, pt)
Hv_View   view;
int       sc;
int       sd;
Hv_Point  *pt;
...
D 3
static int WhichScint(View, pp, scintNum, scintData, pt)
Hv_View             View;
...
D 3
Hv_Item  MallocScintillator(View, sect, ID)
...
D 3
void SetScintGeometrySector(View)
 ...
 */
D 3
static void ComputeScintPoints (View, sect, sc, bit, pt)
Hv_View   View ;
int       sect;        /* range 0 - 2  - use the top scintillators */
int       sc ;         /* range 1 - 48 */
int       bit ;        /* range 1, 2, 3 */
Hv_Point *pt ;         /* addr of rectangular poly */
E 3
I 3
...
D 3
static void Front16Scintillators (View, sect, minid, maxid, pt1, pt2, pt3)
Hv_View     View;
short       sect ;
short       minid;
short       maxid;
...
D 3
void      DrawScintItem(Item, region)
...
D 3
void  GetSlabPolygon(View, sect, slab, poly)

Hv_View  View;
short    sect;   /*C Index */
short    slab;   /*C Index */
Hv_Point *poly;  /* previously malloced */
...
D 3
static void      FixScintRegion(Item)
...
static void   EditScintItem(hvevent)
...
static void EditScintColor(w)

Widget    w;          /* widget doing callback */
...
void ScintSlabLimits(ID, minid, maxid)
