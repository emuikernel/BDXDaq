...
short __stdcall VME_DGG(usb_dev_handle *hdev, unsigned short channel, unsigned short trigger,unsigned short output, unsigned short delay, unsigned short gate, unsigned short invert, unsigned short latch);
