...
public:
	...
	int m_iSectorNum;
	void UpdateControls(BOOL bUpdateScalers = TRUE);
...
// Dialog Data
	...
	CSpinButtonCtrl	m_spinE_ECtotE_Dly;
	CSpinButtonCtrl	m_spinE_ECinE_Dly;
	CSpinButtonCtrl	m_spinE_CC_Dly;
	...
	CString	m_stTOF2;
	CString	m_stE_CC;
	CString	m_stE_CC_Dly;
	CString	m_stE_ECC;
	CString	m_stE_ECinE;
	CString	m_stE_ECinE_Dly;
	CString	m_stE_ECtotE;
	CString	m_stE_ECtotE_Dly;
	CString	m_stE_ECC_Scaler;
	//}}AFX_DATA
...
protected:
	...
	afx_msg void OnDeltaposSpECcDly(NMHDR* pNMHDR, LRESULT* pResult);
	afx_msg void OnDeltaposSpEEcineDly(NMHDR* pNMHDR, LRESULT* pResult);
	afx_msg void OnDeltaposSpEEctoteDly(NMHDR* pNMHDR, LRESULT* pResult);
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
