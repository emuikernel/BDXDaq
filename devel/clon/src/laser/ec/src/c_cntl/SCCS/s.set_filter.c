h03305
s 00035/00035/00594
d D 1.2 04/08/11 12:10:57 sergpozd 3 1
c "camac3" --> char *EC_laser_roc="camac1"
e
s 00000/00000/00000
d R 1.2 00/09/21 14:11:10 Codemgr 2 1
c SunPro Code Manager data about conflicts, renames, etc...
c Name history : 1 0 laser/ec/src/c_cntl/set_filter.c
e
s 00629/00000/00000
...
/*************** 9 end command  ****************/ 
 ...
 /************/
 printf(" filter setting (integer eg 2000) =?");
 scanf("%d,\n",&setting);
 printf(" using filter = %d \n",setting);
  ...
  sleep(1);
     ...
     sprintf(exename,"exec {laser_motor(\"$12%d\")}",setting);
      printf("%s \n",exename);
D 3
     DP_cmd("camac3",exename,result,111);
E 3
