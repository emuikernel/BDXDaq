h47852
s 00059/00059/01479
d D 1.3 04/08/11 15:42:31 sergpozd 4 3
c "camac3" --> char *EC_laser_roc="camac1"
e
s 00001/00000/01537
d D 1.2 01/01/15 14:24:38 giovanet 3 1
c *** empty log message ***
e
s 00000/00000/00000
d R 1.2 00/09/21 14:11:13 Codemgr 2 1
c SunPro Code Manager data about conflicts, renames, etc...
c Name history : 1 0 laser/ec/src/c_cntl/unix_master.c
e
s 01537/00000/00000
d D 1.1 00/09/21 14:11:12 wolin 1 0
c date and time created 00/09/21 14:11:12 by wolin
e
u
U
f e 0
...
/***************************************************/
D 4
 sprintf(prog_msg,"waiting till camac3 returns = %s \n",camac_state);
E 4
I 4
...
D 4
             {flag_camac3_ok=1; 
              sprintf(prog_msg," camac 3 in booted state crate OK \n\n");
E 4
I 4
             {flag_camac1_ok=1; 
...
E 4
             ...
             {
D 4
              sprintf(prog_msg," camac 3 reached but not in booted state \n\n");
E 4
I 4
...
/**********  execute a systems command    *********/
 ...
 if((tp1-tp_reboot_start) > 120)
   {
D 4
     sprintf(prog_msg1," rebooting camac 3 ");
E 4
I 4
...
D 4
     sprintf(exename1,"roc_reboot camac3");
E 4
I 4
...
E 4
   ...
   {
D 4
     sprintf(prog_msg1," reboot camac 3 request not completed. Need to wait for 2 minutes ");
E 4
I 4
