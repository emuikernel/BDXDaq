h52267
s 00001/00001/00090
d D 1.2 02/08/28 21:56:28 boiarino 3 1
c //fclose(spar_old);
e
s 00000/00000/00000
d R 1.2 70/01/01 00:00:02 Codemgr 2 1
c SunPro Code Manager data about conflicts, renames, etc...
c Name history : 1 0 pedman/s/ec2_siger.C
e
s 00091/00000/00000
...
FILE *ped_new = fopen("/usr/local/clas/parms/pedman/archive/ec2.ped","r");
//FILE *spar_old = fopen("/usr/local/clas/parms/initfiles/croc11.spar","r");


// Create 2d histogram
  hpxpy  = new TH2F("hpxpy"," EC2  Sigma",70,0,69,26,0,25);
