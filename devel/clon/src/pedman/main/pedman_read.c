...
main(int argc, char **argv)
{
  ...
  sprintf(program_name1,"spar_hardread");
  sprintf(program_name2,"ped_hardread");
  ...
  if(!strcmp(argv[1],"ec1"))
  {
    ...
    printf("%s \n",result);
    tcpClientCmd("ec1",program_name2,result);
    printf("%s \n",result);
  }
  else if(!strcmp(argv[1],"ec2"))
  {
    ...
    printf("%s \n",result1);
    tcpClientCmd("ec2",program_name2,result1);
    printf("%s \n",result1);
  }
  else if(!strcmp(argv[1],"sc1"))
  {
    ...
    printf("%s \n",result);
    tcpClientCmd("sc1",program_name2,result);
    printf("%s \n",result);
  }
  else if(!strcmp(argv[1],"cc1"))
  {
    ...
    printf("%s \n",result);
    tcpClientCmd("cc1",program_name2,result);
    printf("%s \n",result);
  }
  else if(!strcmp(argv[1],"lac1"))
  {
    ...
    printf("%s \n",result);
    tcpClientCmd("lac1",program_name2,result);
    printf("%s \n",result);
  }
  else
  {
