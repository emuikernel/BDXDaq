...
c Name history : 1 0 Hv/sold/Hv_private.h
e
s 01181/00000/00000
...
extern XmString        Hv_balloonXmst[Hv_MAXBALLOONSTR];   /* Motif strings for balloons*/
...
extern Colormap	        Hv_colorMap;	   /* this program's color map */
...
extern XVisualInfo      Hv_visualInfo;      /* Visual info structure */
...
extern GC	        Hv_gc;              /* main graphics context */

extern XtAppContext     Hv_appContext;      /* Application Context */

/* private global widgets */

extern Widget	       Hv_toplevel;	     /* highest level widget  (Shell widget) */
extern Widget	       Hv_form;              /* form widget for main window */
extern Widget	       Hv_canvas;	     /* main drawing area */
extern Widget	       Hv_menuBar;	     /* Main Menu bar in main window */
...
/* related to library mode */

extern Boolean          Hv_libMode;   /* set true if using Hv to build anotherlibrary ala ced*/
extern Boolean          Hv_libDone;

/* private global menus */

extern Widget	       Hv_popupMenu;
extern Widget          Hv_popupMenu2;
extern Widget          Hv_undoSubmenu;
...
extern void            Hv_CopyColor(short,
				    short);
...
extern Hv_Widget       Hv_CreateManagedPushButton(Hv_Widget,
						  char *,
						  short,
						  XtCallbackProc,
						  XtPointer);
...
extern void           Hv_PopupMenuShell(Widget        w,
					XButtonPressedEvent *event,
					String        *params,
					Cardinal       *num_params);

extern void            Hv_PopdownMenuShell(void);
...
extern void            Hv_ButtonPress(Widget      w,
				      XtPointer   client_data,
				      XEvent      *event);

extern void            Hv_PointerMotion(Widget     w,
					XtPointer  client_data,
					XEvent	   *event);

extern void            Hv_ButtonRelease(Widget      w,
					XtPointer   client_data,
					XEvent     *event);
...
extern void            Hv_LocalRectangleToPSLocalRectangle(XRectangle *local,
							   XRectangle *ps);
...
extern void            Hv_DrawString(short,
				     short,
				     Hv_String *);
...
extern void	       Hv_PolygonEnclosingRectangle(XRectangle *,
						    Hv_Point *,
						    int);
...
extern void            Hv_PSDrawSegments(XSegment  *segs,
					 short    n,
					 short    color);
...
extern void	      Hv_SetXRectangle(XRectangle	*r,
				       short	left,
				       short	top,
				       short	width,		
				       short  height);
...
extern void            Hv_UnionRectangleWithRegion(XRectangle  *xr,
						   Hv_Region  region);
...
extern XmString        Hv_CreateMotifString(char  *str,
					    short  font);

extern XmString        Hv_CreateAndSizeMotifString(char    *text,
						   short   font,
						   short   *w,
						   short   *h);
