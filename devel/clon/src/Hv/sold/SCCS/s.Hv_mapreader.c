h45646
s 00000/00000/00000
d R 1.2 02/08/25 23:21:16 Codemgr 2 1
c SunPro Code Manager data about conflicts, renames, etc...
c Name history : 1 0 Hv/sold/Hv_mapreader.c
e
s 00284/00000/00000
d D 1.1 02/08/25 23:21:15 boiarino 1 0
c date and time created 02/08/25 23:21:15 by boiarino
e
u
U
f e 0
...
/* if still don't have it, give up */
  ...
  if (!mapfile) {
    fprintf(stderr, "Cannot run without maps!\nExiting.\n");
    exit (-1);
  }
...

{
  ...
  fprintf(stderr, "checking mapfile...");
  rewind(mapfile);
...
/* pre convert as appropriate for MERCATOR maps */
  ...
  fprintf(stderr, "Map file understood\n");
}
