...
c Name history : 1 0 Hv/sold/Hv_undo.c
e
s 00124/00000/00000
...

{
  ...
  XtSetSensitive(Hv_popupItems[Hv_FirstSetBit(Hv_UNDOVIEW)], anythingdirty);
  XtSetSensitive(Hv_lastItems[Hv_LASTITEMDRAG], dirtydrag);
  XtSetSensitive(Hv_lastItems[Hv_LASTITEMROTATE], dirtyrotate);
