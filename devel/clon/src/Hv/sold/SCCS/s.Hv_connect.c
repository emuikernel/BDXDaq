...
c Name history : 1 0 Hv/sold/Hv_connect.c
e
s 00647/00000/00000
...

{
  ...
  if ((Item1 == NULL) || (Item2 == NULL)) {
    fprintf(stderr, "WARNING: attempt to make connection with a NULL item.\n");
    return NULL;
  }

  if (Item1 == Item2) {
    fprintf(stderr, "WARNING: attempt to make connect an item with itself.\n");
    return NULL;
  }
...
/* only hotrect items on the same view can be connected */
  ...
  if ((Item1->view) != (Item2->view)) {
    fprintf(stderr, "WARNING: attempt to make connection between items on different views.\n");
    return NULL;
  }

  if ((Item1->domain != Hv_INSIDEHOTRECT) || (Item2->domain != Hv_INSIDEHOTRECT)) {
    fprintf(stderr, "WARNING: attempt to make connection between non hotrect items.\n");
    return NULL;
  }
