...
dmdatabase()
{
  ...
  for(ii=1; ii<=30; ii++)
  {
    sprintf(fname,"DCADBCRATE_%02d.dmcfg",ii);
    fd = fopen(fname,"w");
    if(fd!=NULL)
    {
  ...
  for(jj=1; jj<=12; jj++)
  {
    sprintf(fname,"DCADBBOARD_%02d_%02d.dmcfg",ii,jj);
    fd = fopen(fname,"w");
    if(fd!=NULL)
    {
      chmod(fname,S_IRUSR|S_IWUSR|S_IRGRP|S_IWGRP|S_IROTH|S_IWOTH);
  ...
  for(ii=1; ii<=11; ii++)
  {
    sprintf(fname,"DCTDCCRATE_%02d.dmcfg",ii);
    fd = fopen(fname,"w");
    if(fd!=NULL)
    {
      chmod(fname,S_IRUSR|S_IWUSR|S_IRGRP|S_IWGRP|S_IROTH|S_IWOTH);
  ...
  for(jj=1; jj<=25; jj++)
  {
    ...
    sprintf(fname,"DCTDCBOARD_%02d_%02d.dmcfg",ii,jj);
    fd = fopen(fname,"w");
    if(fd!=NULL)
    {
      chmod(fname,S_IRUSR|S_IWUSR|S_IRGRP|S_IWGRP|S_IROTH|S_IWOTH);
  ...
  for(ii=1; ii<=18; ii++)
  {
    sprintf(fname,"DCLVSUPPLY_%02d.dmcfg",ii);
    fd = fopen(fname,"w");
    if(fd!=NULL)
    {
      chmod(fname,S_IRUSR|S_IWUSR|S_IRGRP|S_IWGRP|S_IROTH|S_IWOTH);
  ...
  for(jj=1; jj<=24; jj++)
  {
    ...
    sprintf(fname,"DCFUSE_%02d_%02d.dmcfg",ii,jj);
    fd = fopen(fname,"w");
    if(fd!=NULL)
    {
      chmod(fname,S_IRUSR|S_IWUSR|S_IRGRP|S_IWGRP|S_IROTH|S_IWOTH);
