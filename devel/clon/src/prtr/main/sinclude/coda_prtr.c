...
skipfbpm:
          ...
          uthfill(evt->histf, 197, 0.5, 0., 1.);
          uthfill(evt->histf, 198, 0.5, 0., 1.);
          uthfill(evt->histf, 197, 1.5, 0., 1.);
          uthfill(evt->histf, 198, 1.5, 0., 1.);
          nevents1_chunk ++;
/*start_timer();*/
          if((ntrk=prlib(jw,track)) > 0)
          {
            /*printf("prlib pass\n");*/
            uthfill(evt->histf, 197, 2.5, 0., 1.);
            uthfill(evt->histf, 198, 2.5, 0., 1.);
...
/*stop_timer(1000);5500microsec for g9frost*/
#endif
#ifdef TRLIB
...
printf("put 32\n");
...
#ifdef PRLIB
        uthunpak(evt->histf, 197, mm->Ratio, " ", 0);
        ...
        if(mm->numread2[myid] > 0)
        {
          ...
          uth2bos(evt->histf,197,(long *)jw);
          uth2bos(evt->histf,198,(long *)jw);
		...
		*/
        ...
        if(mm->numread2[myid] > 0)
        {
		  ...
		  */
          ...
          uth2bos(evt->histf,81,(long *)jw);
          uth2bos(evt->histf,82,(long *)jw);
          uth2bos(evt->histf,83,(long *)jw);
          uth2bos(evt->histf,84,(long *)jw);
          uth2bos(evt->histf,85,(long *)jw);
          uth2bos(evt->histf,86,(long *)jw);
          uth2bos(evt->histf,87,(long *)jw);
          uth2bos(evt->histf,187,(long *)jw);

          uth2bos(evt->histf,167,(long *)jw);
          uth2bos(evt->histf,169,(long *)jw);
          uth2bos(evt->histf,170,(long *)jw);
          uth2bos(evt->histf,171,(long *)jw);
          uth2bos(evt->histf,172,(long *)jw);
          uth2bos(evt->histf,173,(long *)jw);
          uth2bos(evt->histf,174,(long *)jw);
          uth2bos(evt->histf,175,(long *)jw);

          /* reset prompt histograms - uth2bos() does reset !!!
          uthreset(evt->histf, 19, " ");
          uthreset(evt->histf, 198, " "); */
