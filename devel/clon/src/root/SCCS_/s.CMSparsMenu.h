...
c Name history : 1 0 clas/root/CMSparsMenu.h
e
s 00074/00000/00000
...
T
I 1
#ifndef CMSparsMenu_H
#define CMSparsMenu_H
...
class CMSparsMenu : public TGTransientFrame {
...
public:
                   CMSparsMenu(const TGWindow *p, const TGWindow *main,
                               UInt_t w, UInt_t h,
