h39014
s 00001/00001/00568
d D 1.3 05/02/28 19:32:05 boiarino 4 3
c *** empty log message ***
e
s 00122/00015/00447
d D 1.2 03/04/17 17:00:42 boiarino 3 1
c *** empty log message ***
e
s 00000/00000/00000
d R 1.2 01/11/19 16:44:44 Codemgr 2 1
c SunPro Code Manager data about conflicts, renames, etc...
c Name history : 1 0 clas/root/CMDisplay.cxx
e
s 00462/00000/00000
...
D 3
//   m_Canvas = new TCanvas("Canvas", (char*)title,14,47,1100,800);
...
D 3
//old version stuff   m_Canvas->SetEditable(kIsNotEditable);
...
D 3
   char *but7 = "2*2";
   //   char *but7 = "DisplayPtr->MoveTarget(13)";
   //   char *but5 = "m_Epics->SetValue("kepco_command",-1.0)";
   button = new TButton("8",but7,x0,y-dbutton,x1,y);
E 3
I 3
...
I 3
  ...
  fi.fFileTypes = (char **) gOpenAsTypes; // does not compiled without  cast !?
...
char *CMDisplay::SaveFileDialog()
{
  ...
  static TGFileInfo fi;
  fi.fFileTypes = (char **) gSaveAsTypes; // does not compiled without  cast !?
