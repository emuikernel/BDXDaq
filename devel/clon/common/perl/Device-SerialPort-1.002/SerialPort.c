...
XS(XS_Device__SerialPort__Bits_get_hash)
{
    dXSARGS;
    if (items != 0)
	Perl_croak(aTHX_ "Usage: Device::SerialPort::Bits::get_hash()");
    {
#line 44 "SerialPort.xs"
	HV *	hv;
	char *	key;
	SV *	value;
#line 62 "SerialPort.c"
	SV *	RETVAL;
#line 49 "SerialPort.xs"
	/* initialize the hash */
	hv = newHV();
#ifdef _SC_CLK_TCK
