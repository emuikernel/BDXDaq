...
int    tdc1190TriggerTimeTag(int id, UINT32 flag);
...
options coding:
  byte0: BERR/FIFO
  byte1: SNGL/BLT/MBLT/2eVME/2eSST
  byte2: A24/A32
  byte3: CBLT/
*/
#define TDC1190_D32_BERR   0x00000100 /* single word readout with VMEBUS error */
#define TDC1190_D32_FIFO   0x00000101 /* single word readout with event fifo */

#define TDC1190_BLT_BERR   0x00000200 /* D32 DMA readout with VMEBUS error */
#define TDC1190_BLT_FIFO   0x00000201 /* D32 DMA readout with event fifo */

#define TDC1190_MBLT_BERR  0x00000300 /* D64 DMA readout with VMEBUS error */
#define TDC1190_MBLT_FIFO  0x00000301 /* D64 DMA readout with event fifo */

#define TDC1190_2eSST_BERR 0x00000500 /* D64 2eSST DMA readout with VMEBUS error */
#define TDC1190_2eSST_FIFO 0x00000501 /* D64 2eSST DMA readout with event fifo */
