...
epicsShareExtern void (*pvar_func_drvLoveRegister)(void);
...
{
    const char *bldTop = "/jlab/clas/devel/R3.14.12.3/synApps/synApps_5_5/support/love-3-2-4";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"loveApp_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
