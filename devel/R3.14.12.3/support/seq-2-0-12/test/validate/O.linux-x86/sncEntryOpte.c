/* SNC Version 2.0.12: Wed Oct 22 21:38:08 2014: sncEntryOpte.i */
...
extern struct seqProgram sncentryopte;
...
int main(int argc,char *argv[]) {
    ...
    threadId = seq((void *)&sncentryopte, macro_def, 0);
    if(callIocsh) {
...
{
# line 23 "../sncEntryOpte.st"
# line 29 "../sncEntryOpte.st"
...
static void A_ss1_low(SS_ID ssId, struct UserVar *pVar, short transNum)
{
	...
	case 0:
		{
# line 22 "../sncEntryOpte.st"
			printf("low, v = %g, now changing to high\n", v);
		}
		return;
	case 1:
		{
# line 26 "../sncEntryOpte.st"
...
{
# line 43 "../sncEntryOpte.st"
# line 48 "../sncEntryOpte.st"
...
static void A_ss1_high(SS_ID ssId, struct UserVar *pVar, short transNum)
{
	...
	case 0:
		{
# line 42 "../sncEntryOpte.st"
			printf("changing to low\n");
		}
		return;
	case 1:
		{
# line 46 "../sncEntryOpte.st"
...
struct seqProgram sncentryopte = {
...
void sncentryopteRegistrar (void) {
    seqRegisterSequencerCommands();
    seqRegisterSequencerProgram (&sncentryopte);
}
epicsExportRegistrar(sncentryopteRegistrar);
