...
XS(XS_CA_new)
{
    dXSARGS;
    if (items < 2)
	Perl_croak(aTHX_ "Usage: CA::new(class, name, ...)");
    {
...
XS(XS_CA_DESTROY)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: CA::DESTROY(ca_ref)");
    {
	SV *	ca_ref = ST(0);
...
XS(XS_CA_context_destroy)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: CA::context_destroy(class)");
    {
	const char *	class = (const char *)SvPV_nolen(ST(0));
...
XS(XS_CA_change_connection_event)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: CA::change_connection_event(ca_ref, sub)");
    {
	SV *	ca_ref = ST(0);
	SV *	sub = ST(1);
...
XS(XS_CA_put)
{
    dXSARGS;
    if (items < 2)
	Perl_croak(aTHX_ "Usage: CA::put(ca_ref, val, ...)");
    SP -= items;
    {
	SV *	ca_ref = ST(0);
	SV *	val = ST(1);
...
XS(XS_CA_put_callback)
{
    dXSARGS;
    if (items < 3)
	Perl_croak(aTHX_ "Usage: CA::put_callback(ca_ref, sub, val, ...)");
    SP -= items;
    {
	SV *	ca_ref = ST(0);
	SV *	sub = ST(1);
...
XS(XS_CA_put_acks)
{
    dXSARGS;
    if (items < 2)
	Perl_croak(aTHX_ "Usage: CA::put_acks(ca_ref, sevr, ...)");
    SP -= items;
    {
	SV *	ca_ref = ST(0);
	SV *	sevr = ST(1);
...
XS(XS_CA_put_ackt)
{
    dXSARGS;
    if (items < 2)
	Perl_croak(aTHX_ "Usage: CA::put_ackt(ca_ref, ack, ...)");
    SP -= items;
    {
	SV *	ca_ref = ST(0);
...
XS(XS_CA_get)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: CA::get(ca_ref)");
    {
	SV *	ca_ref = ST(0);
...
XS(XS_CA_value)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: CA::value(ca_ref)");
    {
	SV *	ca_ref = ST(0);
	SV *	RETVAL;
...
XS(XS_CA_get_callback)
{
    dXSARGS;
    if (items < 2)
	Perl_croak(aTHX_ "Usage: CA::get_callback(ca_ref, sub, ...)");
    SP -= items;
    {
	SV *	ca_ref = ST(0);
	SV *	sub = ST(1);
...
XS(XS_CA_create_subscription)
{
    dXSARGS;
    if (items < 3)
	Perl_croak(aTHX_ "Usage: CA::create_subscription(ca_ref, mask_str, sub, ...)");
    {
	SV *	ca_ref = ST(0);
...
XS(XS_CA_clear_subscription)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: CA::clear_subscription(class, mon_ref)");
    {
	const char *	class = (const char *)SvPV_nolen(ST(0));
	SV *	mon_ref = ST(1);
...
XS(XS_CA_pend_io)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: CA::pend_io(class, timeout)");
    {
	const char *	class = (const char *)SvPV_nolen(ST(0));
...
XS(XS_CA_test_io)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: CA::test_io(class)");
    {
	const char *	class = (const char *)SvPV_nolen(ST(0));
	int	RETVAL;
	dXSTARG;
...
XS(XS_CA_pend_event)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: CA::pend_event(class, timeout)");
    {
	const char *	class = (const char *)SvPV_nolen(ST(0));
	double	timeout = (double)SvNV(ST(1));
...
XS(XS_CA_poll)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: CA::poll(class)");
    {
	const char *	class = (const char *)SvPV_nolen(ST(0));
...
XS(XS_CA_flush_io)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: CA::flush_io(class)");
    {
	const char *	class = (const char *)SvPV_nolen(ST(0));
...
XS(XS_CA_add_exception_event)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: CA::add_exception_event(class, sub)");
    {
	const char *	class = (const char *)SvPV_nolen(ST(0));
	SV *	sub = ST(1);
...
XS(XS_CA_replace_printf_handler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: CA::replace_printf_handler(class, sub)");
    {
	const char *	class = (const char *)SvPV_nolen(ST(0));
	SV *	sub = ST(1);
...
XS(XS_CA_field_type)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: CA::field_type(ca_ref)");
    {
	SV *	ca_ref = ST(0);
	const char *	RETVAL;
	dXSTARG;
...
XS(XS_CA_element_count)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: CA::element_count(ca_ref)");
    {
	SV *	ca_ref = ST(0);
	int	RETVAL;
	dXSTARG;
...
XS(XS_CA_name)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: CA::name(ca_ref)");
    {
	SV *	ca_ref = ST(0);
	const char *	RETVAL;
	dXSTARG;
...
XS(XS_CA_state)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: CA::state(ca_ref)");
    {
	SV *	ca_ref = ST(0);
	const char *	RETVAL;
	dXSTARG;
...
XS(XS_CA_is_connected)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: CA::is_connected(ca_ref)");
    {
	SV *	ca_ref = ST(0);
	int	RETVAL;
	dXSTARG;
...
XS(XS_CA_host_name)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: CA::host_name(ca_ref)");
    {
	SV *	ca_ref = ST(0);
	const char *	RETVAL;
	dXSTARG;
...
XS(XS_CA_read_access)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: CA::read_access(ca_ref)");
    {
	SV *	ca_ref = ST(0);
	int	RETVAL;
	dXSTARG;
...
XS(XS_CA_write_access)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: CA::write_access(ca_ref)");
    {
	SV *	ca_ref = ST(0);
	int	RETVAL;
	dXSTARG;
