...
/* Generated from ../O.Common/ip.dbd */
...
static const char * const deviceSupportNames[116] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[116] = {
...
int ip_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/jlab/clas/devel/R3.14.12.3/synApps/synApps_5_5/support/ip-2-10";
    ...
    registerDevices(pbase, 116, deviceSupportNames, devsl);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"ip_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    ip_registerRecordDeviceDriver(*iocshPpdbbase);
}
