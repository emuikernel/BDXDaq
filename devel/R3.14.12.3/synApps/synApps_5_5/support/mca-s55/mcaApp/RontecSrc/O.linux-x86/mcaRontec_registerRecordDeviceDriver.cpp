...
epicsShareExtern void (*pvar_func_mcaRontecRegister)(void);
...
{
    const char *bldTop = "/jlab/clas/devel/R3.14.12.3/synApps/synApps_5_5/support/mca-s55";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"mcaRontec_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
