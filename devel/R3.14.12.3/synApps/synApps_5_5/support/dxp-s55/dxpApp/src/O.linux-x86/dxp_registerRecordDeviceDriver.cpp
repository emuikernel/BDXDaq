...
/* Generated from ../O.Common/dxp.dbd */
...
epicsShareExtern void (*pvar_func_NDDxpRegister)(void);
epicsShareExtern void (*pvar_func_dxpMEDRegistrar)(void);
...
int dxp_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/jlab/clas/devel/R3.14.12.3/synApps/synApps_5_5/support/dxp-s55";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"dxp_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    dxp_registerRecordDeviceDriver(*iocshPpdbbase);
}
