...
/* Generated from ../O.Common/iocdelaygenApp.dbd */
...
epicsShareExtern dset *pvar_dset_devAidg535;
...
epicsShareExtern dset *pvar_dset_devAodg535;
...
epicsShareExtern dset *pvar_dset_devBidg535;
...
epicsShareExtern dset *pvar_dset_devBodg535;
...
epicsShareExtern dset *pvar_dset_devLidg535;
...
epicsShareExtern dset *pvar_dset_devLodg535;
...
epicsShareExtern dset *pvar_dset_devMbbidg535;
...
epicsShareExtern dset *pvar_dset_devMbbodg535;
...
epicsShareExtern dset *pvar_dset_devSidg535;
...
epicsShareExtern dset *pvar_dset_devSodg535;
...
epicsShareExtern void (*pvar_func_digitalDelayRegister)(void);
epicsShareExtern void (*pvar_func_drvAsynColbyRegister)(void);
epicsShareExtern void (*pvar_func_drvAsynDG645Register)(void);
epicsShareExtern void (*pvar_func_nigpibInterposeRegister)(void);
epicsShareExtern void (*pvar_func_drvAsynCoherentSDGRegister)(void);
...
epicsShareExtern int *pvar_int_digitalDelayDebug;
static struct iocshVarDef vardefs[] = {
	...
	{"digitalDelayDebug", iocshArgInt, (void * const)pvar_int_digitalDelayDebug},
	{NULL, iocshArgInt, NULL}
};

int iocdelaygenApp_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/jlab/clas/devel/R3.14.12.3/synApps/synApps_5_5/support/delaygen-1-0-5";
    ...
    (*pvar_func_digitalDelayRegister)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"iocdelaygenApp_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    iocdelaygenApp_registerRecordDeviceDriver(*iocshPpdbbase);
}
