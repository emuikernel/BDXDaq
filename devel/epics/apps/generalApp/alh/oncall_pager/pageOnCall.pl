...
#
#  example:
#  pageOnCall.pl -s "Torus" -m "PI1022=HIGH" -pgNum "num1" -pgNum "num2"
#  pageOnCall.pl -d -s "Torus" -m "PI1022=HIGH" -pgNum "num1"
#
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#-----------------------------------------------------------------------
...
if (!@opt_pgNum) { @opt_pgNum = ($PRIMARY_ON_CALL, $SECONDARY_ON_CALL);}
...
$lockFile = $tmpDir.$signal."_".$sigSVR.".LOCK";
...
sub printHelp {
	...
	print "\n   pageOnCall.pl -s \"Torus\" -m \"PI1022=HIGH\" -pgNum \"584-1111\" -pgNum \"584-2222\"";
	print "\n This will page the Primary & Secondary oncall and 584-2222:";
	print "\n   pageOnCall.pl -d -s \"Torus\" -m \"PI1022=HIGH\" -pgNum \"584-2222\"\n\n";
}
