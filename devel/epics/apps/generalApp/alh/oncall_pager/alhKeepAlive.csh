...
ps -elo pid,args | grep alh | grep '/home/epics/log/oncall_pager pager.alhConfig' | grep -v grep 
#>/dev/null
...
if ( $? == 0 ) then
    ...
    setenv EPICS_CA_ADDR_LIST "129.57.96.7 129.57.163.255 129.57.208.90 129.57.57.188 129.57.96.81 129.57.255.12"
