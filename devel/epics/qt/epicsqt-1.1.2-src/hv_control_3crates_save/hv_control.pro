...
unix:!macx: LIBS += -L$$MYEPICSQT/ca_framework/qwt-5.2.1/lib/ -lqwt
...
unix:!macx: LIBS += -L$$MYEPICSQT/ca_framework/plugins/ -lQCaPlugin

INCLUDEPATH += $$MYEPICSQT/ca_framework/plugins/include
DEPENDPATH += $$MYEPICSQT/ca_framework/plugins/include

INCLUDEPATH += $$MYEPICSQT/ca_framework/data/include
DEPENDPATH += $$MYEPICSQT/ca_framework/data/include
INCLUDEPATH += $$MYEPICSQT/ca_framework/api/include
DEPENDPATH += $$MYEPICSQT/ca_framework/api/include
INCLUDEPATH += $$MYEPICSQT/ca_framework/widgets/include
DEPENDPATH += $$MYEPICSQT/ca_framework/widgets/include
