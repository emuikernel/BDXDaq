...
HvCrate::HvCrate(int *types, char **fsm_names, int boards_number, int type) :  QObject(){
 ...
 //   warning_db->setStyleSheet("QLabel { background : red; border: 1px solid black ; color : black; }");
    ...
    HvCrate::bturnonallchannels->setText(QApplication::translate("MainWindow","turn on board\n all channels", 0, QApplication::UnicodeUTF8));
    ...
    HvCrate::bturnoffallchannels->setText(QApplication::translate("MainWindow","turn off board\n all channels", 0, QApplication::UnicodeUTF8));
    ...
    HvCrate::bcrateon->setText(QApplication::translate("MainWindow","turn on \n all crate", 0, QApplication::UnicodeUTF8));
    ...
    HvCrate::bcrateoff->setText(QApplication::translate("MainWindow","turn off \n all crate", 0, QApplication::UnicodeUTF8));
...
if(MainWindow::hvcrate->warning_db->isVisible()) return;
    ...
    for(int i12=0;i12<2;i12++)  // temporal
