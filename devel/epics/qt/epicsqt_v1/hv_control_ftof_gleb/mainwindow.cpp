...
char *board_names_by_crate[3][16]={
  ////  {"B_HV000_0_P0","B_HV000_2_P0" },
{"B_FTOF_HV000_0_P0","B_FTOF_HV000_1_P0","B_FTOF_HV000_2_P0","B_FTOF_HV000_3_P0","B_FTOF_HV000_4_P0","B_FTOF_HV000_5_P0", "B_FTOF_HV000_6_P0","B_FTOF_HV000_7_P0","B_FTOF_HV000_8_P0","B_FTOF_HV000_9_P0"
    ,"B_FTOF_HV000_10_P0","B_FTOF_HV000_11_P0","B_FTOF_HV000_12_P0","B_FTOF_HV000_13_P0","B_FTOF_HV000_14_P0","B_FTOF_HV000_15_P0" },
...
int board_types_by_crate[3][16]={
    ...
    {HvCrate::CAEN_A1535, HvCrate::CAEN_A1535, HvCrate::CAEN_A1535, HvCrate::CAEN_A1535, HvCrate::CAEN_A1535, HvCrate::CAEN_A1535,
     HvCrate::CAEN_A1535, HvCrate::CAEN_A1535, HvCrate::CAEN_A1535, HvCrate::CAEN_A1535, 0, 0, 0, 0, 0, 0},
...
void HvCrate::cb_update_db(){
  ...
  static int under_processing=0;
 char tmp[264];  // temporal
  if( !under_processing){
    under_processing=1;
...
HvCrate::HvCrate(int *types, char **fsm_names, int boards_number, int type) :  QObject(){
 ...
 //   warning_db->setStyleSheet("QLabel { background : red; border: 1px solid black ; color : black; }");
    ...
    for(int i=0;i<boards_number;i++){
     ...
     hvb[i]->setText(QApplication::translate("MainWindow", tmp, 0, QApplication::UnicodeUTF8));
    ...
    HvCrate::bturnonallchannels->setGeometry(QRect(200+10*60, 20, 90, 30));
    HvCrate::bturnonallchannels->setVisible(true);
    HvCrate::bturnonallchannels->setText(QApplication::translate("MainWindow","turn on \n all channels", 0, QApplication::UnicodeUTF8));
    ...
    HvCrate::bturnoffallchannels->setGeometry(QRect(200+10*60, 50, 90, 30));
    HvCrate::bturnoffallchannels->setVisible(true);
    HvCrate::bturnoffallchannels->setText(QApplication::translate("MainWindow","turn off \n all channels", 0, QApplication::UnicodeUTF8));
    connect(HvCrate::bturnoffallchannels, SIGNAL(clicked()), this, SLOT(s_turnoffallchannels()));

    HvCrate::bstore= new QPushButton(mainw);
    HvCrate::bstore->setGeometry(QRect(750, 550, 140, 30));
    HvCrate::bstore->setVisible(true);
    HvCrate::bstore->setText(QApplication::translate("MainWindow","store crate\n configuration", 0, QApplication::UnicodeUTF8));
    connect(HvCrate::bstore, SIGNAL(clicked()), this, SLOT(s_store()));

    HvCrate::bload= new QPushButton(mainw);
    HvCrate::bload->setGeometry(QRect(750, 580, 140, 30));
    HvCrate::bload->setVisible(true);
    HvCrate::bload->setText(QApplication::translate("MainWindow","load crate\n configuration", 0, QApplication::UnicodeUTF8));
...
//printf("construct\n");fflush(stdout);
    ...
    for(int j=0;j<HvCrate::params_read;j++){
        ...
        HvCrate::label_hvpar[j]->setText(QApplication::translate("MainWindow", params_labels_caen[j], 0, QApplication::UnicodeUTF8));
        HvCrate::label_hvpar[j]->setGeometry(QRect(200+j*60, 20, 60, 20));
    ...
    for(int j=0;j<HvCrate::params_switch;j++){
        ...
        HvCrate::label_hvpar[j+HvCrate::params_read]->setText(QApplication::translate("MainWindow", params_labels_caen[j+HvCrate::params_read], 0, QApplication::UnicodeUTF8));
        HvCrate::label_hvpar[j+HvCrate::params_read]->setGeometry(QRect(200+(j+HvCrate::params_read)*60, 20, 60, 20));
    ...
    for(int j=0;j<HvCrate::params_set;j++){
        ...
        HvCrate::label_hvpar[j+HvCrate::params_read+HvCrate::params_switch]->setText(QApplication::translate("MainWindow", params_labels_caen[j+HvCrate::params_read+HvCrate::params_switch], 0, QApplication::UnicodeUTF8));
        HvCrate::label_hvpar[j+HvCrate::params_read+HvCrate::params_switch]->setGeometry(QRect(200+(j+HvCrate::params_read+HvCrate::params_switch)*60, 20, 60, 20));
...
//         HvCrate::hvch[i].hvpar_read[j]->setVisible(false);
         ...
         HvCrate::hvch[i].hvpar_read[j]->setGeometry(QRect(200+j*60, 20+i10*20, 60, 20));
  ...
  //       HvCrate::hvch[i].hvpar_switch[j]->setVisible(false);
         ...
         HvCrate::hvch[i].hvpar_switch[j]->setGeometry(QRect(200+(j+HvCrate::params_read)*60, 20+i10*20, 80, 20));
    ...
    //     HvCrate::hvch[i].hvpar_set[j]->setVisible(false);
         ...
         HvCrate::hvch[i].hvpar_set[j]->setGeometry(QRect(200+(j+HvCrate::params_read+HvCrate::params_switch)*60, 20+i10*20, 60, 20));
    ...
    if(HvCrate::crate_type==CrateButton::CAEN_1527 && parameter==2){
     ...
     setText(qs);
       ...
       for(int i=15;i>=5;i--){
        ...
        if(i==7 || i==6)continue;
        if((1<<i) & status){/*printf("%d %d \n", i, j10);fflush(stdout);*/qs=QString(statuses_527[j10]);}
