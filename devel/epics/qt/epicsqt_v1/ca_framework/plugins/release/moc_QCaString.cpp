...
#include "../../data/include/QCaString.h"
...
void QCaString::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QCaString *_t = static_cast<QCaString *>(_o);
        switch (_id) {
        case 0: _t->stringChanged((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< QCaAlarmInfo(*)>(_a[2])),(*reinterpret_cast< QCaDateTime(*)>(_a[3])),(*reinterpret_cast< const uint(*)>(_a[4]))); break;
        case 1: _t->writeString((*reinterpret_cast< const QString(*)>(_a[1]))); break;
...
const QMetaObjectExtraData QCaString::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QCaString::staticMetaObject = {
    { &qcaobject::QCaObject::staticMetaObject, qt_meta_stringdata_QCaString,
      qt_meta_data_QCaString, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QCaString::getStaticMetaObject() { return staticMetaObject; }
