...
***************************************************************************/
/*sergey:
./SunOS_sun4u/bin/mysql_client_test -hclondb1 -uclient_test_db -pclient_test_db
 */
...
*/
/*sergey: set default values we want*/
static char *opt_user= "client_test_db";
static char *opt_password= "client_test_db";
static char *opt_host= "clondb1";
...
#ifdef VXWORKS
static unsigned int opt_count= 1;
#else
...
static void get_options(int *argc, char ***argv)
{
  ...
  if (tty_password)
  {
    printf("ERROR: get_tty_password() was removed !!!\n");
    /*sergey: opt_password= get_tty_password(NullS);*/
  }
  return;
}
...
main(int argc, char **argv)
{
  ...
  for (iter_count= 1; iter_count <= opt_count; iter_count++)
  {
    ...
    {
	  printf("here ...\n");
      for (fptr= my_tests; fptr->name; fptr++) (*fptr->function)();	
    }
    else
    {
      for ( ; *argv ; argv++)
