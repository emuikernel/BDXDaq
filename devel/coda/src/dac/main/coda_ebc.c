...
/*printf("[%1d] deb3 typ=%d\n",id,typ);fflush(stdout);*/
      ...
      else
      {
        ...
        printf("[%1d] deb21 desc1->soe=0x%08x, 1st=0x%08x, 2nd=0x%08x 3rd=0x%08x 4th=0x%08x (before=0x%08x)\n",id,desc1->soe,data[0],data[1],data[2],data[3],data[-1]);fflush(stdout);
        printf("[%1d] deb21 5=0x%08x, 6=0x%08x 7=0x%08x 8=0x%08x \n",id,data[4],data[5],data[6],data[7]);fflush(stdout);
        /*exit(0);*/
      }
/*
