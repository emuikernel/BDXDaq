...
/* fdump.c (former bosiodump.c) - dump FPACK file */
...
main(int argc, char **argv)
{
  ...
  char kname[9], hname[9], format[17];
  kname[8] = '\0';
  hname[8] = '\0';
  format[16] = '\0';
...
printf("-3\n");fflush(stdout);
	*/
    ...
    {
      ikey++;
      if(ierr != 0) printf("?fdump...error on frkey: %d\n",ierr);
