...
/* vmearol1.c - first readout list for VME crates using new Bryan Moffit's library (Feb 2011) */
...
/* readout list VMEAROL1 */
#define ROL_NAME__ "VMEAROL1"
...
/* name used by loader */
#ifdef STANDALONE
#define INIT_NAME vmearol1_standalone__init
#else
#define INIT_NAME vmearol1__init
#endif
...
/*   fadcA32Base = 0x08000000; */
  ...
  /* window: position 850=3400ns, size 100=400ns*/
  /*faSetProcMode(FA_SLOT,1,850,100,3,6,1,0);*/
  faSetProcMode(FA_SLOT,1,900,100,3,6,1,0);
