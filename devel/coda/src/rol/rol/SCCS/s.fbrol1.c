h13518
s 00001/00001/01056
d D 1.7 10/03/09 12:38:41 boiarino 7 6
c *** empty log message ***
e
s 00009/00002/01048
d D 1.6 10/03/09 12:36:02 boiarino 6 5
c *** empty log message ***
e
s 00025/00013/01025
d D 1.5 07/09/27 10:42:18 boiarino 5 4
c some fixes for standalone mode
c 
e
s 00004/00001/01034
d D 1.4 07/09/14 15:20:06 boiarino 4 3
c *** empty log message ***
e
s 00003/00004/01032
d D 1.3 07/09/14 15:14:30 boiarino 3 2
c *** empty log message ***
e
s 00004/00000/01032
d D 1.2 07/09/14 13:59:31 boiarino 2 1
c *** empty log message ***
e
s 01032/00000/00000
...
I 3
D 4
/*following code will produce endless scan if run in standalone mode (!!??)*/
E 4
I 4
D 5
...
D 5
wheb 'busy' for that logic is off then gates keep coming into ADC and cleanup
never ends */
E 5
I 5
...
{
  long EVENT_LENGTH;
  unsigned long ii, jj, type, datascan, cc;
...
E 5
  *sfi.sequencerEnable = 1; /* enable SFI Sequencer */
  ...
  /* put 1in the first word of the CODA header */
  jw[-2 ] = 1;
