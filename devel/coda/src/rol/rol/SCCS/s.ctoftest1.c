h28820
s 00033/00009/00654
d D 1.2 10/09/27 09:57:09 boiarino 2 1
c *** empty log message ***
e
s 00663/00000/00000
d D 1.1 10/03/09 12:47:43 boiarino 1 0
c 
e
u
U
...
__prestart()
{
  ...
  */
  ...
  for(i=1; i<=32; i++) uthbook1(histi, 130+i, "TDC", 4000, 0, 4000);
  for(i=1; i<=8; i++) uthbook1(histi, 162+i, "ADC", 2000, 0, 2000);
...
D 2
  unsigned int nwords, nwords1, nevent, buff[32], buff1[32];
E 2
I 2
...
I 2
      ...
      if(!(nevent%1000)) logMsg("Got TDC event # %d, ADC event # %d\n",nevent,nevent1,3,4,5,6);
E 2
	  ...
	  {
D 2
        logMsg("TDC ERROR: extra event !!! recovered\n",1,2,3,4,5,6);
E 2
        goodtoread = 0;
I 2
        tdcrec=1;
...
E 2
      ...
      {
D 2
        logMsg("ADC ERROR: extra event !!! recovered\n",1,2,3,4,5,6);
E 2
        goodtoread = 0;
I 2
        adcrec=1;
...
E 2
    ...
    if((ind2 = bosMlink_(jw,"CT  ",0)) > 0)
    {
      ...
      for(i=0; i<nwords; i++)
      {
        ...
        if(k < 9)
		{
          if(adc>0 && adc<2000) uthfill(histi, 130+32+k, adc, 0, 1);
		}
      }
