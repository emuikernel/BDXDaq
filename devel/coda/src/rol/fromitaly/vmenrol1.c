...
/* v1190 start */
  ...
  tdc1190SetDefaultWindowWidth(1500); /*1.5 us */
  tdc1190SetDefaultWindowOffset(-3900); /*-3.9 us*/
  /*tdc1190Config(TDC1190_MBLT_FIFO); /* Lo programma in trigger matching mode */
  tdc1190Config(TDC1190_MBLT_FIFO);/*andrea*/
/* v1190 end */
...
*/
  ...
  /* v1720Config(TDC1190_MBLT_FIFO);Andrea*/
  v1720Config(TDC1190_MBLT_FIFO);
