h44607
s 00004/00004/00216
d D 1.3 09/01/28 23:11:13 boiarino 3 2
c *** empty log message ***
e
s 00011/00010/00209
d D 1.2 08/10/25 09:33:41 puneetk 2 1
c fixed a bug for reading the IC_*out.txt files and added feature which lets you
c disable or enable channels for the IC and hodoscope separately.
c 
e
s 00219/00000/00000
d D 1.1 08/10/21 16:21:08 puneetk 1 0
c date and time created 08/10/21 16:21:08 by puneetk
e
u
U
f e 0
...
D 2
    printf("  To enable or disable all discriminator channels, use:\n");
E 2
I 2
...
E 2
  ...
  if (processAll == 1) {
D 2
    printf("%s all discriminators and channels", str);
    for (int i = 1; i <= 33; i++) {
      sprintf(exename, "v895%sAll(%u)", str, GetDiscAddress(i));
E 2
I 2
