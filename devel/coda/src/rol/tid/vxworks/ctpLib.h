...
struct CTP_FPGAStruct
{
  ...
  /* 0xn18 */ volatile unsigned int enable[2]; //  6-7
};
...
struct TID_CTPStruct
{
  ...
  /* 0x3C20 */          unsigned int blankCTP1[(0x5C00-0x3C20)/4];
  /* 0x5C00 */ struct   CTP_FPGAStruct fpga2;
  /* 0x5C20 */          unsigned int blankCTP2[(0x7C00-0x5C20)/4];
  /* 0x7C00 */ struct   CTP_FPGAStruct fpga3;
  /* 0x7C20 */ volatile unsigned int sum_threshold_lsb;  //  8
  /* 0x7C24 */ volatile unsigned int sum_threshold_msb;  //  9
  /* 0x7C28 */ volatile unsigned int history_buffer_lsb; // 10
  /* 0x7C2C */ volatile unsigned int history_buffer_msb; // 11
