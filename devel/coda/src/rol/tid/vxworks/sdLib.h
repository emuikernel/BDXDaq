...
struct TID_SDStruct
{
  ...
  /* 0x3c08 */ volatile unsigned int payloadSlots; // 2
  /* 0x3c0C */ volatile unsigned int tokenSlots;   // 3
  /* 0x3c10 */ volatile unsigned int busyoutSlots; // 4
  /* 0x3c14 */ volatile unsigned int trigoutSlots; // 5
...
int  sdReset();
int  sdSetActivePayloadSlots(unsigned int imask);
int  sdGetActivePayloadSlots();
