...
//
// Description:
//      Verify State Transition Class. Performs Verify Transition on the
//      DAQ system
//
// Author:  
//      Jie Chen
...
//
//
#ifndef _CODA_VERIFIER_H
#define _CODA_VERIFIER_H

#include <transitioner.h>

class verifier: public transitioner
{
public:
  // constructor and destructors
  verifier (daqSystem* system);
  ~verifier (void);

  virtual const char* className (void) const {return "verifier";}
...
private:
  ...
  verifier& operator = (const verifier&);
};
#endif
