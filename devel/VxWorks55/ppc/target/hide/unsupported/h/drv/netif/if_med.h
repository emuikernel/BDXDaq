...
--------------------
02g,15jul97,spm  removed unused control field bPromisc from BSD 4.4 driver
02g,06dec96,cdp  changed ARM to DCR_ARM to avoid clash with ARM arch.
...
#define DCR_ARM	0x10       /* autoinitialize remote DMA      */
