/* bootpd.c - Unsupported CMU BOOTP server */
...
01b,04dec97,spm  added modification history; updated to allow Solaris builds
                 with native Solaris compiler
01a,???????,???  created.
*/

#ifndef lint
static char sccsid[] = "@(#)bootp.c	2.1 (Stanford) 1/22/86";
static char rcsid[] = "$Header: bootpd.c,v 2.1 93/06/07 15:18:41 wise active $";
#endif
...
#include <sys/stat.h>
#include <net/if.h>
#if defined (SUNOS40) || defined (SOLARIS)
