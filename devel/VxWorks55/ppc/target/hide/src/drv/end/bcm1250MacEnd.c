...
#include "drv/end/bcm1250MacEnd.h"
...
#define KVTOPHYS(x) ((UINT32)(x) & 0x7FFFFFFF)
...
*
* Function to calculate dest addr hash value.
* See bcm1250 manual page 9-190
*
* RETURNS: Destination address hash value.
*/
...
/*******************************************************************************
*
* bcm1250MacSetConfig(pDrvCtrl, speed)
*
* Configure LAN speed, Ethernet duplex and flow control options for this MAC.
*
* RETURNS: OK if successful, ERROR if invalid parameters
*/
...
/*******************************************************************************
*
* bcm1250MacAddr2Reg - Convert 6 byte MAC address into 64 bit value.
*
* This routine converts the hardware ethernet MAC address from an array of
* six byte vaules into a 64 bit register value.
*
* RETURNS: 64 bit hardware ethernet MAC address
*/
...
*
* It first sends START and WRITE command, followed by address of physical
* interface chip, then register index. It then sends ACK and register value
* to be written.
*
* RETURNS: N/A
*/
