...
--------------------
01e,27oct01,dat  Adding warnings about obsolete drivers
...
/* pciIomapShow is being obsoleted. Please use pciConfigLib instead. */

#warning "src/drv/pci/pciIomapShow.c is outdated. Please use pciConfigShow"
...
/*******************************************************************************
*
* pciFindClassShow - find a device by class, then print an information.
*
* This routine finds a device by class, then print an information.
*
* RETURNS:
* OK, or ERROR if this library is not initialized.
*
