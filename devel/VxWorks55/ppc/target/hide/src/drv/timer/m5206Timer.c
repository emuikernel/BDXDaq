/* m5206Timer.c - Timer driver for Motorola MCF5206 */
...
01b,07jul97,mem  added timestamp driver support.
01a,21jan97,kab  created from m5204Timer.c
*/

/*
DESCRIPTION
This is the timer for the MCF5206 ColdFire CPU.  It provides system clock,
auxillary clock and timestamp functionality.

If INCLUDE_M5206_SYS_CLK is defined, the system clock is provided.
...
If INCLUDE_M5206_AUX_CLK is defined, the auxillary clock is provided.
...
If INCLUDE_M5206_TIMESTAMP is defined, a timestamp driver based on the
system clock is provided.  If this option is selected,
INCLUDE_M5206_SYS_CLK must also be defined.
...
#ifdef INCLUDE_M5206_SYS_CLK
#ifndef SYS_CLK_TIMER
#error "INCLUDE_M5206_SYS_CLK requires SYS_CLK_TIMER be defined"
#endif
...
#ifdef INCLUDE_M5206_AUX_CLK
#ifndef AUX_CLK_TIMER
#error "INCLUDE_M5206_AUX_CLK requires AUX_CLK_TIMER be defined"
#endif
...
#if (defined(INCLUDE_M5206_SYS_CLK) && defined(INCLUDE_M5206_AUX_CLK) \
    && (SYS_CLK_TIMER == AUX_CLK_TIMER))
#error "SYS_CLK_TIMER and AUX_CLK_TIMER must be different"
#endif

#if defined(INCLUDE_M5206_TIMESTAMP) && !defined(INCLUDE_M5206_SYS_CLK)
#error "INCLUDE_M5206_TIMESTAMP requires INCLUDE_M5206_SYS_CLK"
#endif
...
#endif /* INCLUDE_M5206_AUX_CLK */

#ifdef	INCLUDE_M5206_TIMESTAMP
#include "drv/timer/timestampDev.h"

LOCAL BOOL	sysTimestampRunning	= FALSE; 

#endif	/* INCLUDE_M5206_TIMESTAMP */
...
LOCAL void sysClkInt (void)
    ...
    *M5206_TIMER_TER(SIM_BASE, SYS_CLK_TIMER) = 0x02;
...
void sysClkDisable (void)
	...
	{
#if (SYS_CLK_TIMER == 1)
	*M5206_SIM_IMR(SIM_BASE) |= M5206_IMR_TIMER1;
#else /* (SYS_CLK_TIMER == 1) */
	*M5206_SIM_IMR(SIM_BASE) |= M5206_IMR_TIMER2;
#endif /* (SYS_CLK_TIMER == 1) */

	/* Clear CLK1-CLK0 to stop timer. */
	*M5206_TIMER_TMR(SIM_BASE, SYS_CLK_TIMER) = 0x00;
	sysClkRunning = FALSE;
	}
    }
...
void sysClkEnable (void)
	...
	*M5206_TIMER_TMR(SIM_BASE, SYS_CLK_TIMER) = 0x00;
	...
	/* Reset timer count */
	*M5206_TIMER_TCN(SIM_BASE, SYS_CLK_TIMER) = 0x00;
	...
	*M5206_TIMER_TRR(SIM_BASE, SYS_CLK_TIMER) = sysClkCount;

	/* Start timer */
	*M5206_TIMER_TMR(SIM_BASE, SYS_CLK_TIMER) = 0x1b | (sysClkPrescale<<8);
...
LOCAL void sysAuxClkInt (void)
    {
    /* Clear interrupt condition */
    *M5206_TIMER_TER(SIM_BASE, AUX_CLK_TIMER) = 0x02;
...
void sysAuxClkDisable (void)
	...
	*M5206_SIM_IMR(SIM_BASE) |= M5206_IMR_TIMER2;
	...
	/* Clear CLK1-CLK0 to stop timer. */
	*M5206_TIMER_TMR(SIM_BASE, AUX_CLK_TIMER) = 0x00;
...
void sysAuxClkEnable (void)
	...
	*M5206_TIMER_TMR(SIM_BASE, AUX_CLK_TIMER) = 0x00;
	...
	/* Reset timer count */
	*M5206_TIMER_TCN(SIM_BASE, AUX_CLK_TIMER) = 0x00;
	...
	/* Set reference register */
	*M5206_TIMER_TRR(SIM_BASE, AUX_CLK_TIMER) = sysAuxClkCount;

	/* Start timer */
	*M5206_TIMER_TMR(SIM_BASE, AUX_CLK_TIMER) =
...
UINT32 sysTimestampFreq (void)
    ...
    prescale = ((*M5206_TIMER_TMR(SIM_BASE, SYS_CLK_TIMER) >> 8) + 1);
...
UINT32 sysTimestamp (void)
    {
    return (*M5206_TIMER_TCN(SIM_BASE, SYS_CLK_TIMER));
    }
