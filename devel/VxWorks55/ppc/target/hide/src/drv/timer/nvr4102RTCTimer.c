/* nvr4102RTCTimer.c - NEC Vr4102 (RTC) timer driver */
...
--------------------
01b,30dec99,jmw  casting NULL to int to stop compiler warning.
01a,11sep97,mem written.
*/
...
the Vr4102 RTC module.  This library handles auxiliary clock
functions.
...
LOCAL void sysAuxClkInt (void)
    ...
    *VR4102_RTCINTREG = VR4102_RTC_RTCINTR1;
...
void sysAuxClkDisable (void)
	...
	key = intLock ();
	*VR4102_ICU_MSYSINT1REG &= ~VR4102_RTCL1INTR;
...
void sysAuxClkEnable (void)
	...
	for (i = 0; i < 2; ++i)
	    ...
	    *VR4102_RTCL1LREG = sysAuxClkTicks & 0xffff;
	    *VR4102_RTCL1HREG = (sysAuxClkTicks >> 16) & 0xff;

	    /* set RTCLong counter register */
    
	    *VR4102_RTCL1CNTLREG = sysAuxClkTicks & 0xffff;
	    *VR4102_RTCL1CNTHREG = (sysAuxClkTicks >> 16) & 0xff;
	    }
