...
/* CREATED BY /usr/local/clas/devel/VXWORKS/ppc/host/src/hutils/makeSymTbl.tcl
 *  WITH ARGS ppc tmp.o symTbl.c
 *         ON Tue Mar 09 12:39:57 EST 2004
 */
...
IMPORT int _remque ();
IMPORT int _res;
IMPORT int _res_opcodes;
IMPORT int _res_resultcodes;
IMPORT int _restf14 ();
IMPORT int _restf15 ();
IMPORT int _restf16 ();
IMPORT int _restf17 ();
...
SYMBOL standTbl [4121] =
    {
        ...
        {{NULL}, "__fp_query", (char*) __fp_query, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "__p_class", (char*) __p_class, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "__p_time", (char*) __p_time, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "__p_type", (char*) __p_type, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "_res_opcodes", (char*) &_res_opcodes, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "_res_resultcodes", (char*) &_res_resultcodes, 0, SYM_GLOBAL | SYM_DATA},
        ...
        {{NULL}, "dnsDebug", (char*) dnsDebug, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "p_cdname", (char*) p_cdname, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "p_fqname", (char*) p_fqname, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "p_rr", (char*) p_rr, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "wdbAltivecInit", (char*) wdbAltivecInit, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "wdbTaskAltivecInit", (char*) wdbTaskAltivecInit, 0, SYM_GLOBAL | SYM_TEXT},
