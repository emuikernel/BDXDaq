...
--------------------
01d,17nov00,dmw  Code cleanup.
01c,28oct00,krp  Changed sysCalcPciSpd() to index from Control Status Reg.
01b,08oct00,dmw  Hardcoded bus speed to 100MHz.
01a,31aug00,dmw  Written (from verison 01c of mcpn765/sysVpd.c).
*/
...
static UINT tableHarrier[] =       /* PCI clock ratios times two */
    {
     0,   2,   4,   6,   3,   0,   5,  0
    };
...
LOCAL UINT sysCalcPciSpd (void)
    ...
    index = (*(UINT32 *)(HARRIER_GLOBAL_CONTROL_STATUS_REG) & 
            HARRIER_GCSR_RAT_MASK) >> 8;
    busDivisor = tableHarrier[index];
