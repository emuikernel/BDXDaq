...
#define	INCLUDE_MV64260_DMA /* MV64260 DMA */

/*#undef  INCLUDE_VME_DMA */    /* Universe (VME) DMA */
#define INCLUDE_VME_DMA     /* Universe (VME) DMA */
...
/* Sergey: include temperature control copied from mv6100 */
...
/* Sergey: increase upto 1GB */
#define	PCI0_MSTR_MEMIO_SIZE  0x40000000 /*0x00800000*/	/* 8 MB */
...
/* Sergey: if 'undef', DMA from DRAM to DRAM does not work !!!
(GT64260 manual page 336: cache coherent DRAM access need burst <= 32 bytes) */ 
