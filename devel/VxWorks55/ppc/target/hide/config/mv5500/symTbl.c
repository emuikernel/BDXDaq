 ...
 *         ON Tue Apr 01 11:57:25 EDT 2008
 */
...
IMPORT int sysMv64260DevBusInit ();
IMPORT int sysMv64260DmaAbort ();
IMPORT int sysMv64260DmaArbiterSet ();
IMPORT int sysMv64260DmaInit ();
IMPORT int sysMv64260DmaPause ();
IMPORT int sysMv64260DmaResume ();
IMPORT int sysMv64260DmaStart ();
IMPORT int sysMv64260DmaStatus ();
IMPORT int sysMv64260I2cAckIn ();
IMPORT int sysMv64260I2cAckOut ();
IMPORT int sysMv64260I2cRead ();
IMPORT int sysMv64260I2cStart ();
IMPORT int sysMv64260I2cStop ();
IMPORT int sysMv64260I2cWrite ();
IMPORT int sysMv64260IntInit ();
IMPORT int sysMv64260PhbInit ();
IMPORT int sysMv64260RegInit ();
IMPORT int sysMv64260SdramInit ();
IMPORT int sysMv64260SmcShow ();
IMPORT int sysMv64260SpdShow ();
IMPORT int sysMv64260UsDelay ();
...
IMPORT int sysVmeDmaCnfgGet ();
IMPORT int sysVmeDmaCnfgSet ();
IMPORT int sysVmeDmaInit ();
IMPORT int sysVmeDmaL2VCopy ();
IMPORT int sysVmeDmaStatusGet ();
IMPORT int sysVmeDmaV2LCopy ();
IMPORT int sysVpd;
...
IMPORT int vmeLsiWin;
IMPORT int vmeVsiWin;
IMPORT int vmpxx ();
IMPORT int vmxExcLoad ();
...
SYMBOL standTbl [4652] =
    {
        ...
        {{NULL}, "sys543EepromDump", (char*) sys543EepromDump, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysMv64260DevBusInit", (char*) sysMv64260DevBusInit, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260DmaAbort", (char*) sysMv64260DmaAbort, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260DmaArbiterSet", (char*) sysMv64260DmaArbiterSet, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260DmaInit", (char*) sysMv64260DmaInit, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260DmaPause", (char*) sysMv64260DmaPause, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260DmaResume", (char*) sysMv64260DmaResume, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260DmaStart", (char*) sysMv64260DmaStart, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260DmaStatus", (char*) sysMv64260DmaStatus, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260I2cAckIn", (char*) sysMv64260I2cAckIn, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260I2cAckOut", (char*) sysMv64260I2cAckOut, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260I2cRead", (char*) sysMv64260I2cRead, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260I2cStart", (char*) sysMv64260I2cStart, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260I2cStop", (char*) sysMv64260I2cStop, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260I2cWrite", (char*) sysMv64260I2cWrite, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260IntInit", (char*) sysMv64260IntInit, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260PhbInit", (char*) sysMv64260PhbInit, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260RegInit", (char*) sysMv64260RegInit, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260SdramInit", (char*) sysMv64260SdramInit, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260SmcShow", (char*) sysMv64260SmcShow, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260SpdShow", (char*) sysMv64260SpdShow, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMv64260UsDelay", (char*) sysMv64260UsDelay, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysVmeDmaCnfgGet", (char*) sysVmeDmaCnfgGet, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysVmeDmaCnfgSet", (char*) sysVmeDmaCnfgSet, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysVmeDmaInit", (char*) sysVmeDmaInit, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysVmeDmaL2VCopy", (char*) sysVmeDmaL2VCopy, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysVmeDmaStatusGet", (char*) sysVmeDmaStatusGet, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysVmeDmaV2LCopy", (char*) sysVmeDmaV2LCopy, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "vmeLsiWin", (char*) &vmeLsiWin, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "vmeVsiWin", (char*) &vmeVsiWin, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "vmpxx", (char*) vmpxx, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "vmxExcLoad", (char*) vmxExcLoad, 0, SYM_GLOBAL | SYM_TEXT},
