...
/*--> harrier-related definitions from prpmc800/config.h <--*/

/* Motorola IDs ? */
#define HARRIER_SUB_VNDR_ID_VAL	    0x4817 /*PRPMC800_SUB_SYS_ID_VAL*/
#define HARRIER_SUB_SYS_ID_VAL      0x1057 /*MOT_SUB_VNDR_ID_VAL*/


/* memory size which will be mapped onto the local PCI bus through
the Harrier inbound translation zero register set */
#define PCI2DRAM_MAP_SIZE    ((UINT)0x08000000)

#define PCI_MSTR_ZERO_SIZE   ((UINT)0x00400000)		  /* 4 MB */


/*--> harrier-related definitions from prpmc800/prpmc800.h <--*/
...
#define PCI_MSTR_ZERO_LOCAL PCI_MSTR_MEM_LOCAL + PCI_MSTR_MEM_SIZE
