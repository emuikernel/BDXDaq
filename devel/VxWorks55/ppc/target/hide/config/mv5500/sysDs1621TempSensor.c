...
/*Sergey: we have 64260 bridge; will include some defines manually
#include "mv64360I2c.h"*/
#include "mv64260I2c.h"
#define MV64360_REG_BASE                MV64260_REG_BASE
...
#define sysMv64360I2cStart              sysMv64260I2cStart
#define sysMv64360I2cStop               sysMv64260I2cStop
#define sysMv64360I2cRead               sysMv64260I2cRead
#define sysMv64360I2cWrite              sysMv64260I2cWrite
#define sysMv64360I2cAckIn              sysMv64260I2cAckIn
/*Sergey: end of my defines*/
...
STATUS sysDs1621TempRegsInterpret
	...
	temperature = temperature -(counter/slope);
...
STATUS sysDs1621TemperatureShow (void)
    ...
    if (sysDs1621TemperatureGet(pDs1621Temp) == ERROR)
	return (ERROR);
