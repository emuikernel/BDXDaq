...
logMsg("pciBus=%d pciDevice=%d pciFunc=%d bar0[0x%08x]=0x%08x\n",
pReso->pciBus,pReso->pciDevice,pReso->pciFunc,PCI_CFG_BASE_ADDRESS_0,bar0,0);
...
LOCAL void sys543PhySpecRegsInit
    ...
    /*    printf("sys543PhySecRegsInit: phyAddr = %d, %d %d\n",phyAddr,phyId1,phyId2); */
