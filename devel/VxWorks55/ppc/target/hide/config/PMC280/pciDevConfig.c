...
#define PCI_UNUSED_DEVICE_NO			0x1F /*P2P Configuration Register: Device No */
...
void pciAutoConfigNonMonarch()
{
    ...
    /*Sergey: Motorola added following 3 lines to fix mv6100 problem */
    /* Initializing the Device No to PCI_UNUSED_DEVICE_NO (Assumed to be unused) */
    GT_REG_READ(PCI_0_P2P_CONFIG, &temp);
	temp |= (PCI_UNUSED_DEVICE_NO <<24);
    GT_REG_WRITE(PCI_0_P2P_CONFIG, temp);
