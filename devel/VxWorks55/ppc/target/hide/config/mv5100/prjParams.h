...
/* sergey: define following to make epics happy */
#define INCLUDE_CPLUS_STRING
#undef INCLUDE_CPLUS_COMPLEX
#define INCLUDE_CPLUS_STL

/* DMA good, if both undef, or both defined, or only INCLUDE_CPLUS_IOSTREAMS_FULL defined */
/* DMA bad, if only INCLUDE_CPLUS_IOSTREAMS defined */
#define INCLUDE_CPLUS_IOSTREAMS /*problem here*/
#undef INCLUDE_CPLUS_IOSTREAMS_FULL /*works*/
...
#define DEFAULT_BOOT_LINE "fei(0,0)host:/tornado/mv5100/vxWorks h=90.0.0.1 e=90.0.0.2 u=vxworks"
#undef  RESERVED
...
#define PCI_MSTR_MEM_BUS (TRANSLATE(PCI_MSTR_MEM_LOCAL, PCI_MSTR_MEMIO_LOCAL, PCI_MSTR_MEMIO_BUS))
#undef  PCI_MSTR_MEM_LOCAL
#define PCI_MSTR_MEM_LOCAL (PCI_MSTR_MEMIO_LOCAL+PCI_MSTR_MEMIO_SIZE)
#undef  PCI_MSTR_IO_SIZE
#define PCI_MSTR_IO_SIZE 0x00800000
#undef  PCI_MSTR_IO_BUS
#define PCI_MSTR_IO_BUS (TRANSLATE(PCI_MSTR_IO_LOCAL, ISA_MSTR_IO_LOCAL, ISA_MSTR_IO_BUS))
...
#define PCI_MSTR_MEMIO_LOCAL 0xfd000000
...
#define VME_A32_MSTR_LOCAL 0x20000000
