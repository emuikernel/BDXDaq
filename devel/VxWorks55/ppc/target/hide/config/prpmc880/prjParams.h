...
/*#define INCLUDE_MMU_BASIC Sergey: defined in config.h*/
...
/* undefined reference to `standTblSize',`standTbl' */
/*
...
/* Sergey: redefine */
/* to get boot parameters (used by 'sysNvRamGet' from
 ../target/src/drv/mem/byteNvRam.c)*/
/*does not help !!!*/
#undef  NV_BOOT_OFFSET
#define NV_BOOT_OFFSET BOOT_LINE_OFFSET
/*
#undef  DEFAULT_BOOT_LINE
#define DEFAULT_BOOT_LINE "gei(0,0)host:/tornado/mv5500/vxWorks h=90.0.0.1 e=90.0.0.2 u=vxworks"
#undef  RESERVED
...
#define VME_A16_MSTR_LOCAL ((VME_MEM_LOCAL_END - VME_A16_MSTR_SIZE) &	0xfff00000)
...
#define VME_A24_MSTR_LOCAL ((VME_A16_MSTR_LOCAL - VME_A24_MSTR_SIZE) &	0xfff00000)
#undef  VME_A32_MSTR_SIZE
#define VME_A32_MSTR_SIZE 0x0ff00000
#undef  VME_A32_MSTR_BUS
#define VME_A32_MSTR_BUS 0x08000000
#undef  VME_A32_MSTR_LOCAL
#define VME_A32_MSTR_LOCAL ((VME_A24_MSTR_LOCAL - VME_A32_MSTR_SIZE) &	0xfff00000)
