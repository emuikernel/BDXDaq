...
#ifdef MVME5500_DEBUG__
{
char txt[100];
sprintf(txt,"3: 0xe0000000 -> 0x%08x\r\n",*(volatile UINT32 *)0xe0000000);
sysDebugMsg(txt,CONTINUE_EXECUTION);
}
#endif
...
{
char txt[100];
sprintf(txt,"4: 0xe0000000 -> 0x%08x\r\n",*(volatile UINT32 *)0xe0000000);
sysDebugMsg(txt,CONTINUE_EXECUTION);
}
#endif
...
{
char txt[100];
sprintf(txt,"130: 0xe0000008 -> 0x%08x\r\n",*(volatile UINT32 *)0xe0000008);
sysDebugMsg(txt,CONTINUE_EXECUTION);
}
#endif
...
{
char txt[100];
sprintf(txt,"131: 0xe0000008 -> 0x%08x\r\n",*(volatile UINT32 *)0xe0000008);
sysDebugMsg(txt,CONTINUE_EXECUTION);
}
#endif
...
{
char txt[100];
sprintf(txt,"132: 0xe000000c -> 0x%08x\r\n",*(volatile UINT32 *)0xe000000c);
sysDebugMsg(txt,CONTINUE_EXECUTION);
}
#endif
...
{
char txt[100];
sprintf(txt,"133: 0xe000000c -> 0x%08x\r\n",*(volatile UINT32 *)0xe000000c);
sysDebugMsg(txt,CONTINUE_EXECUTION);
}
#endif
...
printf("Startup Script is included: 0x%08x\n",sysBootParams.startupScript[0]);
