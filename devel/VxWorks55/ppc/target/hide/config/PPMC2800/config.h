...
*/
#define DEFAULT_BOOT_LINE       \
       "mgi(0,0) clon10-daq1:$CODA/VXWORKS_ppc/bin/vx2800 " \
       "e=129.57.68.29:FFFFFF00 " \
       "h=129.57.68.21 " \
       "u=boiarino " \
       "f=0x20 " \
       "tn=croctest12 " \
...
#define CONSOLE_BAUD_RATE 38400/*115200*/	/* Reconfigure default baud rate */
...
#define USER_D_CACHE_MODE  (CACHE_WRITETHROUGH) /*(CACHE_COPYBACK)*/ /* select COPYBACK or DISABLED     */
#else
...
#ifdef PMC280_CACHE_COHERENCY_WT 
#define L2CACHE_MODE     L2CACHE_MODE_WRITETHROUGH   /* L2CACHE_MODE_COPYBACK*/
#else
