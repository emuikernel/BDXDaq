...
#define DEFAULT_DEC_CLK_FREQ	133000000	/* 133 MHz default */
    ...
    )
{
    ...
    if(frcWhoAmI())
    {
        dbg_puts1("CPU1: Entering sysClkConnect...\n");
    }
    else
    {
        dbg_puts0("CPU0: Entering sysClkConnect...\n");
    }
#else
    dbg_puts0("Entering sysClkConnect...\n");
    ...
    if(frcWhoAmI())
    {
        dbg_puts1("CPU1: Exiting sysClkConnect...\n");
    }
    else
    {
        dbg_puts0("CPU0: Exiting sysClkConnect...\n");
    }
#else
    dbg_puts0("Exiting sysClkConnect...\n");
#endif /* PMC280_DUAL_CPU */
#endif /* PMC280_DEBUG_UART_VX */
