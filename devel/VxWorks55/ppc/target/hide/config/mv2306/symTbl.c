 ...
 *         ON Tue Sep 21 17:44:53 EDT 2004
 */
...
IMPORT int dcCSR0Bmr;
IMPORT int dcKickStartTx;
IMPORT int dcReadAllRom ();
...
IMPORT int sysDebugMsg1 ();
IMPORT int sysDec21x40EnetAddrGet ();
IMPORT int sysDec21x40UpdateLoadStr ();
...
SYMBOL standTbl [3819] =
    {
        ...
        {{NULL}, "dcCSR0Bmr", (char*) &dcCSR0Bmr, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "dcKickStartTx", (char*) &dcKickStartTx, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "dcReadAllRom", (char*) dcReadAllRom, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "dcattach", (char*) dcattach, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "lnEnetAddr", (char*) &lnEnetAddr, 0, SYM_GLOBAL | SYM_DATA},
        ...
        {{NULL}, "pciToVmeDev", (char*) &pciToVmeDev, 0, SYM_GLOBAL | SYM_BSS},
        ...
        {{NULL}, "sysAuxClkInit", (char*) sysAuxClkInit, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysDebugMsg1", (char*) sysDebugMsg1, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysDec21x40EnetAddrGet", (char*) sysDec21x40EnetAddrGet, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysDec21x40UpdateLoadStr", (char*) sysDec21x40UpdateLoadStr, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysPciExtRavenInit", (char*) sysPciExtRavenInit, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysRavenErrClr", (char*) sysRavenErrClr, 0, SYM_GLOBAL | SYM_TEXT},
