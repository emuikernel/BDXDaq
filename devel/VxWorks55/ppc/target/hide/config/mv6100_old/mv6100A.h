 ...
 * IPMC Support
 *
 * At this time IPMC is not supported on the MVME6100 board.  However,
 * software support will remain on the off chance that the IPMC connector
 * is repopulated on the board.  Therefore, INCLUDE_IPMC must remain
 * #undef'ed.
 */
...
#   endif
#   define USER_APPL_INIT sysTffsMountDevs(); 
#else
...
/* Sergey */
#define PRESENCE_DETECT_PMC0_MASK    0x01
#define PRESENCE_DETECT_PMC1_MASK    0x02
...
#define VME_MEM_SIZE 		(0x20000000/*Sergey: was 0x20000000*/)	/* Must be power of 2 */
...
/* DJA: change to full 160MB */
#define VME_DRAM_ACCESS_SIZE    (0x0a000000)
...
/* DJA: setup a slave window to provide VME access of CPU memory;
 IN0 window is commented out by '#if 0'*/
#undef VME_A32_SLV_SIZE
#define VME_A32_SLV_SIZE  0x10000000
#   undef  VME_IN1_CFG_PARAMS
#   define VME_IN1_CFG_PARAMS            \
                TRUE,                    \
                0,                       \
                (VME_A32_MSTR_BUS +      \
                 VME_A32_MSTR_SIZE),     /* start of slave win above master win */ \
                0,                       \
                VME_A32_SLV_SIZE,        \
                0,                       \
                LOCAL_MEM_LOCAL_ADRS,    /* base PCI mapped memory */ \
...
#   define VME_IN0_CFG_PARAMS            \
                ...
                0,                       \
                (SM_MEM_ADRS +           /* 0x00010000 - start of actual SM region */ \
                 SM_MEM_SIZE +           /* 0x00020000 */ \
                 SM_OBJ_MEM_SIZE),       /* 0x00010000 */ \
                0,                       \
