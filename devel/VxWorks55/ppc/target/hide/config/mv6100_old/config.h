...
/* Copyright 1996-2004 Motorola, Inc. */
...
#undef 	INCLUDE_AUXCLK          /* MV64360 aux clock support */
#define 	INCLUDE_AUXCLK      /* 'spy' need it; any problems ??? */
...
#ifdef  INCLUDE_MV64360_DMA     /* MV64360 DMA */
...
/*Sergey #define	PCI0_MSTR_MEMIO_SIZE	0x00800000*/	/* 8 MB */
/*Sergey #define	PCI0_MSTR_MEM_SIZE	0x00800000*/	/* 8 MB	*/
...
/*Sergey #define	PCI1_MSTR_MEMIO_SIZE	0x01000000*/	/* 16 MB */
/*Sergey #define	PCI1_MSTR_MEM_SIZE	0x00800000*/	/* 8 MB	*/
...
/* Sergey */
/* PCI0 contains VME */
#define PCI0_MSTR_MEMIO_SIZE  0x10000000
#define PCI0_MSTR_MEM_SIZE    0x10000000
/* PCI1 contains both PMC sites */
#define PCI1_MSTR_MEMIO_SIZE  0x20000000 /* pmc memory will be mapped here ! */
#define PCI1_MSTR_MEM_SIZE    0x08000000

/* Sergey: pmc memory mapping (BAR0) takes whole PCI1_MSTR_MEMIO_SIZE so following
mapping failed (BAR4); is it fine for us ??? */
...
/* DJA: undef LOCAL_MEM_AUTOSIZE and set LOCAL_MEM_SIZE to accual memory size */
/* Sergey: it creates huge delay during cold boot ! */
#undef	LOCAL_MEM_AUTOSIZE	 /* undef for fixed size */
#define LOCAL_MEM_LOCAL_ADRS    0x00000000  /* fixed at zero */
#define LOCAL_MEM_SIZE		    0x20000000  /* Default memory 512MB */
...
#else
/* DJA: change from 0 to 0x10000000 which is 256MB */
#   define USER_RESERVED_MEM    (0x10000000)		/* number of reserved bytes */
#endif
