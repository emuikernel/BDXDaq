...
01a,15dec98,mdp  Written (from version 01j of mv2304/universe.h)
*/
 ...
 *
 * 32 total bits of which 15 are valid and 17 are reserved (not used),
 * one bit per interrupt.
 */

#define UNIV_NUM_INT	15
...
# define UNIVERSE_ADRS(reg)   (CASTINT (univBaseAdrs + reg )) 
#endif  /* UNIVERSE_ADRS */
...
#define UNIVERSE_VERR_INT	0x0400  /* bit setting for VMEbus err intr */
#define	UNIVERSE_RESERVED_INT	0x0800	/* reserved [DO NOT USE] */
...
#define UNIVERSE_VSI4_CTL       UNIVERSE_ADRS(0xF90)
#define UNIVERSE_VSI4_BS        UNIVERSE_ADRS(0xF94)
#define UNIVERSE_VSI4_BD        UNIVERSE_ADRS(0xF98)
#define UNIVERSE_VSI4_TO        UNIVERSE_ADRS(0xF9c)
#define UNIVERSE_VSI5_CTL       UNIVERSE_ADRS(0xFa4)
#define UNIVERSE_VSI5_BS        UNIVERSE_ADRS(0xFa8)
#define UNIVERSE_VSI5_BD        UNIVERSE_ADRS(0xFac)
#define UNIVERSE_VSI5_TO        UNIVERSE_ADRS(0xFb0)
#define UNIVERSE_VSI6_CTL       UNIVERSE_ADRS(0xFb8)
#define UNIVERSE_VSI6_BS        UNIVERSE_ADRS(0xFbc)
#define UNIVERSE_VSI6_BD        UNIVERSE_ADRS(0xFc0)
#define UNIVERSE_VSI6_TO        UNIVERSE_ADRS(0xFc4)
#define UNIVERSE_VSI7_CTL       UNIVERSE_ADRS(0xFcc)
#define UNIVERSE_VSI7_BS        UNIVERSE_ADRS(0xFd0)
#define UNIVERSE_VSI7_BD        UNIVERSE_ADRS(0xFd4)
#define UNIVERSE_VSI7_TO        UNIVERSE_ADRS(0xFd8)
...
#define DGCS_VALID_BITS_MASK	0xe8ffef6f
#define DGCS_CHAIN_MSK		(1 << 27)
#define DGCS_VON_MSK		(0xf << 20)
...
#define LINT_STAT_INT_MASK	0xf7ff		/* mask received interrupts */
...
#define MAST_CTL_PABS_128	(1 << 12)       /* 64 Byte PCI Aligned Burst */
