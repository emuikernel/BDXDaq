...
/* Copyright 1998-1999 Motorola, Inc. */

/*
modification history
--------------------
01b,12jun02,kab  SPR 74987: cplusplus protection
01a,13jan99,rhv  written. (from BUG code written by MG)
*/
...
#define HAWK_ECC_SCIEN		(1<<19)	/* single-bit error count rollover interrupt enable */
...
#define HAWK_ROM_BASE_MASK	(0xFFF<<HAWK_ROM_BASE_SHIFT)
...
#define HAWK_ROM_A_SPEED_MASK	(3<<HAWK_ROM_A_SPEED_SHIFT)
#define HAWK_ROM_B_SPEED_MASK	(3<<HAWK_ROM_B_SPEED_SHIFT)
...
#define HAWK_ROM_BASE(bankno)	(bankno & (UINT)HAWK_ROM_BASE_MASK)
...
#define HAWK_ROM_TYPE(a,b) (a >> ((b == 1) ? 20 : 16))
