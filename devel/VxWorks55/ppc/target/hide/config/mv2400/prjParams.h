...
#define DEFAULT_BOOT_LINE "dc(0,0)host:/tornado/mv2400/vxWorks h=90.0.0.1 e=90.0.0.2 u=vxworks"
#undef  RESERVED
...
#define VME_A32_MSTR_LOCAL 0x10000000
...
#undef  NUM_FILES
#define NUM_FILES 150 /*Sergey: was 50*/
