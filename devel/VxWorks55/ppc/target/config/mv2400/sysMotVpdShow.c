...
--------------------
01c,01jul99,rhv     Changed file name from vpdShow.c to sysMotVpdShow.c per WRS
                    code review.
01b,14jan99,mdp     Fix for Hawk Aux Clock.
01a,14sep98,rhv	    Created.
*/

/*
DESCRIPTION
This file contains the Vital Product Data Show utility routines. To use these
routines, define INCLUDE_VPD and INCLUDE_SHOW_ROUTINES in config.h.
*/
