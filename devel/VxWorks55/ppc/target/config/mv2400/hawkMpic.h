...
--------------------
01c,12may99, rhv  Modified to use new WRS PCI symbols.
01b,05feb99, dmw  Add Count Inhibit define for Timer Base Count reg.
01a,15dec98, mdp  Written (from version 01e of mv2304/ravenMpic.h).
*/
