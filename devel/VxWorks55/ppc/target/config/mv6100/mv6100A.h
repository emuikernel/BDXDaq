...
#   define VME_IN0_CFG_PARAMS            \
      ...
      /* Setup a slave window to provide VME access of CPU memory 
 DJA 8/05  - Set to  256MBytes 0x10000000. Put it above the standard
 A32 Master window to avoid self-access*/
