...
/*
GENERATED: Thu Aug 18 16:13:23 EDT 2005
...
#undef INCLUDE_COM
/*#undef INCLUDE_MV64360_DMA Sergey: defined in config.h, we want that */
#undef INCLUDE_ERROR_HANDLING
#undef INCLUDE_RTC
#undef INCLUDE_FAILSAFE
#undef INCLUDE_DPM
#define INCLUDE_BOOT_IMAGE_PROGRAM /* sergey: define it to get flash programming */
#undef INCLUDE_MV64360_WDOG
/*#undef INCLUDE_DS1621 Sergey: defined in config.h, we want that */
#undef INCLUDE_MV64360_TMRCNTR
...
#define USER_RESERVED_MEM (0x10000000)
*/
#undef  LOCAL_MEM_SIZE
#define LOCAL_MEM_SIZE     0x20000000
#undef  USER_RESERVED_MEM
...
#undef  VME_A16_MSTR_SIZE
#define VME_A16_MSTR_SIZE 0x00010000
#undef  VME_A16_MSTR_BUS
#define VME_A16_MSTR_BUS (0x00000000)
#undef  VME_A16_MSTR_LOCAL
#define VME_A16_MSTR_LOCAL (VME_A24_MSTR_END)
#undef  VME_A24_MSTR_SIZE
#define VME_A24_MSTR_SIZE 0x01000000
#undef  VME_A24_MSTR_BUS
#define VME_A24_MSTR_BUS (0x00000000)
#undef  VME_A24_MSTR_LOCAL
#define VME_A24_MSTR_LOCAL (VME_A32_MSTR_END)
#undef  VME_A32_MSTR_SIZE
#define VME_A32_MSTR_SIZE 0x10000000
#undef  VME_A32_MSTR_BUS
#define VME_A32_MSTR_BUS (0x08000000)
#undef  VME_A32_MSTR_LOCAL
#define VME_A32_MSTR_LOCAL VME_MEM_LOCAL_START
#undef  VME_A16_SLV_SIZE
#define VME_A16_SLV_SIZE (0x0)
#undef  VME_A16_SLV_BUS
#define VME_A16_SLV_BUS (0x0)
#undef  VME_A16_SLV_LOCAL
#define VME_A16_SLV_LOCAL (0x0)
#undef  VME_A24_SLV_SIZE
#define VME_A24_SLV_SIZE (0x0)
#undef  VME_A24_SLV_BUS
#define VME_A24_SLV_BUS (0x0)
#undef  VME_A24_SLV_LOCAL
#define VME_A24_SLV_LOCAL (0x0)

/*sergey: bug !!! it defined in mv6100A.h as equal to 0x10000000,
and mv6100A.h included into config.h BEFORE prjParams.h, so we
will comment it out here
#undef  VME_A32_SLV_SIZE
#define VME_A32_SLV_SIZE (0x0)
*/

#undef  VME_A32_SLV_BUS
#define VME_A32_SLV_BUS (0x0)
#undef  VME_A32_SLV_LOCAL
#define VME_A32_SLV_LOCAL (0x0)
#undef  SYS_CLK_RATE
...
#undef  RESOLVER_DOMAIN_SERVER
#define RESOLVER_DOMAIN_SERVER "90.0.0.3"
#undef  RESOLVER_DOMAIN
#define RESOLVER_DOMAIN "wrs.com"
#undef  DNS_DEBUG
#define DNS_DEBUG FALSE
/* sergey: add 2 following lines to make epics happy */
#undef  SNTP_PORT
