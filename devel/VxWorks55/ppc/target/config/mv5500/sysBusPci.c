...
)
{
  ...
  switch(devVend)
  {
    ...
    case PCI_ID_IBC:
      retVal = ERROR;
#ifdef PCI_AUTO_DEBUG
      sprintf(txt,"sysPciAutoconfigInclude: Excluding IBC\r\n");
      sysDebugMsg(txt,CONTINUE_EXECUTION);
#endif
      break;
    ...
    case PCI_ID_IDE:
      retVal = ERROR;
#ifdef PCI_AUTO_DEBUG
      sprintf(txt,"sysPciAutoconfigInclude: Excluding IDE\r\n");
      sysDebugMsg(txt,CONTINUE_EXECUTION);
#endif
      break;
