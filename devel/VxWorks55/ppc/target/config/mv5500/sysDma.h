...
/* custom functions */
STATUS usrMem2MemDmaCopy(UINT32 chan, UINT32 *sourceAddr, UINT32 *destAddr,
                         UINT32 nbytes);
STATUS usrMem2MemDmaStart(UINT32 chan, UINT32 *sourceAddr, UINT32 *destAddr,
                          UINT32 nbytes);
STATUS usrDmaDone(UINT32 chan);
