...
/* CREATED BY /usr/local/clas/devel_new/VxWorks55/ppc/host/src/hutils/makeSymTbl.tcl
 *  WITH ARGS ppc tmp.o symTbl.c
 *         ON Mon Dec 12 23:45:45 EST 2005
 */
