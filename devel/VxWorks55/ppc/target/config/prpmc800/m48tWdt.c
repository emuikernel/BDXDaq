...
--------------------
01a,06dec00,krp  derived from mv5100/m48tWdt.c source file.
*/
...
Watchdog expiration can be annunicated as either a maskable interrupt (IRQ 8 on
the MVME2400) or as a board reset event. The selection is made by the "reset"
