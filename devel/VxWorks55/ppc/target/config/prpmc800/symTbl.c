 ...
 *         ON Fri Aug 20 11:49:08 EDT 2004
 */
...
IMPORT int gmtime_r ();
IMPORT int h ();
IMPORT int harrierDmaAbort ();
IMPORT int harrierDmaInit ();
IMPORT int harrierDmaPause ();
IMPORT int harrierDmaResume ();
IMPORT int harrierDmaStart ();
IMPORT int harrierDmaStatus ();
...
IMPORT int smcPrintBankInfo ();
IMPORT int smcPrintGeneralCtrl ();
IMPORT int smcPrintTiming ();
IMPORT int smcReadConfig ();
IMPORT int smcShow ();
...
IMPORT int sysEEUnlock ();
IMPORT int sysEnetAddrGet ();
IMPORT int sysExcMsg;
IMPORT int sysFei82557EndLoad ();
IMPORT int sysFlags;
...
IMPORT int sysHarrierCpuToPciWin;
IMPORT int sysHarrierCpuWinOff;
IMPORT int sysHarrierErrClr ();
IMPORT int sysHarrierFixInp ();
IMPORT int sysHarrierInitPhbExt ();
IMPORT int sysHarrierInitPhbExt2 ();
IMPORT int sysHarrierParamConfig ();
IMPORT int sysHarrierPciToCpuWin;
IMPORT int sysHarrierPciWinOff;
IMPORT int sysHarrierPhbInit ();
IMPORT int sysHarrierPhbInit2 ();
...
IMPORT int sysMaxL2Disable ();
IMPORT int sysMaxL2Flush ();
IMPORT int sysMaxL2InvFunc ();
IMPORT int sysMaxL2InvFunc750 ();
IMPORT int sysMclBlkConfig;
IMPORT int sysMemProbeSup ();
IMPORT int sysMemTop ();
IMPORT int sysModeCheck ();
IMPORT int sysModel ();
IMPORT int sysMonarchMode;
IMPORT int sysMotGetDec ();
IMPORT int sysMotI2cRangeRead ();
IMPORT int sysMotI2cRead ();
IMPORT int sysMotI2cWait ();
IMPORT int sysMotI2cWrite ();
IMPORT int sysMotMsDelay ();
IMPORT int sysMpicBusIntGen ();
...
IMPORT int sysPciOutByteConfirm ();
IMPORT int sysPciOutLong ();
IMPORT int sysPciOutLongConfirm ();
...
IMPORT int sysTimeEdges ();
IMPORT int sysToMonitor ();
IMPORT int sysUsDelay ();
IMPORT int sysValidHarrierWindows;
...
SYMBOL standTbl [3931] =
    {
        ...
        {{NULL}, "globalBusIF", (char*) &globalBusIF, 0, SYM_GLOBAL | SYM_DATA},
        ...
        {{NULL}, "harrierDmaAbort", (char*) harrierDmaAbort, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "harrierDmaInit", (char*) harrierDmaInit, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "harrierDmaPause", (char*) harrierDmaPause, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "harrierDmaResume", (char*) harrierDmaResume, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "harrierDmaStart", (char*) harrierDmaStart, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "harrierDmaStatus", (char*) harrierDmaStatus, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "inboundSizeCode", (char*) inboundSizeCode, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "lowMemBufFei", (char*) &lowMemBufFei, 0, SYM_GLOBAL | SYM_BSS},
        ...
        {{NULL}, "mpicBaseAdrs", (char*) &mpicBaseAdrs, 0, SYM_GLOBAL | SYM_BSS},
        ...
        {{NULL}, "smcPrintBankInfo", (char*) smcPrintBankInfo, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "smcPrintGeneralCtrl", (char*) smcPrintGeneralCtrl, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "smcPrintTiming", (char*) smcPrintTiming, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "smcReadConfig", (char*) smcReadConfig, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "smcShow", (char*) smcShow, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysCalcBusSpd", (char*) sysCalcBusSpd, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysConfigDpm", (char*) sysConfigDpm, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysEEUnlock", (char*) sysEEUnlock, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysEnetAddrGet", (char*) sysEnetAddrGet, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysExcMsg", (char*) &sysExcMsg, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "sysFei82557EndLoad", (char*) sysFei82557EndLoad, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysHarrierCpuToPciWin", (char*) &sysHarrierCpuToPciWin, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "sysHarrierCpuWinOff", (char*) &sysHarrierCpuWinOff, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "sysHarrierErrClr", (char*) sysHarrierErrClr, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysHarrierFixInp", (char*) sysHarrierFixInp, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysHarrierInitPhbExt", (char*) sysHarrierInitPhbExt, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysHarrierInitPhbExt2", (char*) sysHarrierInitPhbExt2, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysHarrierParamConfig", (char*) sysHarrierParamConfig, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysHarrierPciToCpuWin", (char*) &sysHarrierPciToCpuWin, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "sysHarrierPciWinOff", (char*) &sysHarrierPciWinOff, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "sysHarrierPhbInit", (char*) sysHarrierPhbInit, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysHarrierPhbInit2", (char*) sysHarrierPhbInit2, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysL2CacheInvFunc", (char*) sysL2CacheInvFunc, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysMaxL2Disable", (char*) sysMaxL2Disable, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMaxL2Flush", (char*) sysMaxL2Flush, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMaxL2InvFunc", (char*) sysMaxL2InvFunc, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMaxL2InvFunc750", (char*) sysMaxL2InvFunc750, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysModeCheck", (char*) sysModeCheck, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysModel", (char*) sysModel, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMonarchMode", (char*) &sysMonarchMode, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "sysMotGetDec", (char*) sysMotGetDec, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMotI2cRangeRead", (char*) sysMotI2cRangeRead, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMotI2cRead", (char*) sysMotI2cRead, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMotI2cWait", (char*) sysMotI2cWait, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMotI2cWrite", (char*) sysMotI2cWrite, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMotMsDelay", (char*) sysMotMsDelay, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysMpicBusIntGen", (char*) sysMpicBusIntGen, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysPciOutByteConfirm", (char*) sysPciOutByteConfirm, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysPciOutLong", (char*) sysPciOutLong, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysPciOutLongConfirm", (char*) sysPciOutLongConfirm, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysTimeEdges", (char*) sysTimeEdges, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysToMonitor", (char*) sysToMonitor, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysUsDelay", (char*) sysUsDelay, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysValidHarrierWindows", (char*) &sysValidHarrierWindows, 0, SYM_GLOBAL | SYM_DATA},
