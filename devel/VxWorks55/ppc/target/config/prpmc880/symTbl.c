 ...
 *         ON Wed Nov 01 16:34:44 EST 2006
 */

#include "vxWorks.h"
#include "symbol.h"

IMPORT int PLDI2CBurstRead ();
IMPORT int PLDI2CBurstWrite ();
IMPORT int PLDI2CRead ();
IMPORT int PLDI2CWrite ();
...
IMPORT int mv64360UartDrvInit ();
IMPORT int mv64360UartDrvInt ();
...
IMPORT int prpmcSlaveWaitConfig ();
...
IMPORT int sysPciConfigReadProbe ();
...
IMPORT int sysPciOutWordConfirm ();
IMPORT int sysPciWriteFlush ();
...
IMPORT int sysRtcDateTimeGet ();
IMPORT int sysRtcDateTimePrint ();
IMPORT int sysRtcDateTimeSet ();
IMPORT int sysRtcDateTimeTest ();
...
SYMBOL standTbl [3968] =
    {
        {{NULL}, "PLDI2CBurstRead", (char*) PLDI2CBurstRead, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "PLDI2CBurstWrite", (char*) PLDI2CBurstWrite, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "PLDI2CRead", (char*) PLDI2CRead, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "PLDI2CWrite", (char*) PLDI2CWrite, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "cpuSmcBusSpeed", (char*) &cpuSmcBusSpeed, 0, SYM_GLOBAL | SYM_DATA},
        ...
        {{NULL}, "mv64360UartDrvInit", (char*) mv64360UartDrvInit, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "mv64360UartDrvInt", (char*) mv64360UartDrvInt, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "prpmcSlaveWaitConfig", (char*) prpmcSlaveWaitConfig, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysMonarchMode", (char*) &sysMonarchMode, 0, SYM_GLOBAL | SYM_DATA},
        ...
        {{NULL}, "sysPciConfigReadProbe", (char*) sysPciConfigReadProbe, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysPciOutWordConfirm", (char*) sysPciOutWordConfirm, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysPciWriteFlush", (char*) sysPciWriteFlush, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysRtcDateTimeGet", (char*) sysRtcDateTimeGet, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysRtcDateTimePrint", (char*) sysRtcDateTimePrint, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysRtcDateTimeSet", (char*) sysRtcDateTimeSet, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "sysRtcDateTimeTest", (char*) sysRtcDateTimeTest, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysSysconAsserted", (char*) sysSysconAsserted, 0, SYM_GLOBAL | SYM_TEXT},
