...
IMPORT int average_error;
IMPORT int avg_out_error;
IMPORT int b ();
IMPORT int bad__C3ios ();
IMPORT int bandwidth ();
IMPORT int bandwidth_n ();
IMPORT int bandwidth_val ();
...
IMPORT int compilername;
IMPORT int compilerversion;
IMPORT int connect ();
...
IMPORT int frcEEPROMDummyWrite ();
IMPORT int frcEEPROMDummyWrite16 ();
...
IMPORT int frcTestbwMem ();
IMPORT int frcTestgettimeofday ();
IMPORT int frcTestlatMemRead ();
...
IMPORT int get_enough ();
IMPORT int get_mem ();
IMPORT int get_myaddress ();
IMPORT int get_n ();
IMPORT int get_results ();
IMPORT int get_word ();
IMPORT int getc ();
IMPORT int getchar ();
IMPORT int getcwd ();
...
IMPORT int getpagesize_lmbench ();
...
IMPORT int gettimeofday_lmbench ();
IMPORT int getw ();
IMPORT int getwd ();
IMPORT int global_align;
IMPORT int global_allstats;
IMPORT int global_assignstruct;
IMPORT int global_bitopstruct;
IMPORT int global_custrun;
IMPORT int global_emfloatstruct;
IMPORT int global_fourierstruct;
IMPORT int global_fstruct;
IMPORT int global_huffstruct;
IMPORT int global_ideastruct;
IMPORT int global_lustruct;
IMPORT int global_min_seconds;
IMPORT int global_min_ticks;
IMPORT int global_nnetstruct;
IMPORT int global_numsortstruct;
IMPORT int global_ofile;
IMPORT int global_ofile_name;
IMPORT int global_strsortstruct;
IMPORT int gmtime ();
IMPORT int gmtime_r ();
...
IMPORT int insertinit ();
IMPORT int insertsort ();
IMPORT int intCnt;
...
IMPORT int ksleep ();
IMPORT int l ();
IMPORT int l_overhead ();
IMPORT int labs ();
IMPORT int last ();
IMPORT int latMemRead ();
IMPORT int lat_h ();
IMPORT int latency ();
IMPORT int ld ();
...
IMPORT int mem_array;
IMPORT int mem_array_ents;
IMPORT int mem_perf ();
IMPORT int memalign ();
...
IMPORT int micro ();
IMPORT int micromb ();
IMPORT int mid_error;
IMPORT int mid_out;
IMPORT int mid_wt_change;
IMPORT int mid_wt_cum_change;
IMPORT int mid_wts;
IMPORT int milli ();
IMPORT int minMove;
IMPORT int minr;
...
IMPORT int outBuffer;
IMPORT int out_error;
IMPORT int out_out;
IMPORT int out_pats;
IMPORT int out_waiting__9streambuf ();
IMPORT int out_wt_change;
IMPORT int out_wt_cum_change;
IMPORT int out_wts;
...
IMPORT int s1;
IMPORT int s2;
IMPORT int save_median ();
IMPORT int save_minimum ();
IMPORT int save_n ();
IMPORT int save_results ();
...
IMPORT int sysTimestampResetRtn;
...
IMPORT int tbReset ();
IMPORT int tbReset_lmbench ();
IMPORT int tbStart;
IMPORT int tbStart_lm;
IMPORT int tbTempHi;
IMPORT int tbTempLo;
IMPORT int tcbinfo;
...
IMPORT int use_int ();
IMPORT int use_pointer ();
IMPORT int use_result_dummy;
IMPORT int usecs_spent ();
...
SYMBOL standTbl [5044] =
    {
        {{NULL}, "AddMemArray", (char*) AddMemArray, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "AllocateMemory", (char*) AllocateMemory, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "CreateFile", (char*) CreateFile, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "DCACHE_CTRL", (char*) &DCACHE_CTRL, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "DCD_regs_dump", (char*) DCD_regs_dump, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "Delta", (char*) Delta, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "DoAssign", (char*) DoAssign, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "DoBitops", (char*) DoBitops, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "DoEmFloat", (char*) DoEmFloat, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "DoEmFloatIteration", (char*) DoEmFloatIteration, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "DoFourier", (char*) DoFourier, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "DoHuffman", (char*) DoHuffman, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "DoIDEA", (char*) DoIDEA, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "DoLU", (char*) DoLU, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "DoNNET", (char*) DoNNET, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "DoNumSort", (char*) DoNumSort, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "DoStringSort", (char*) DoStringSort, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "EEPROMDetect", (char*) EEPROMDetect, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "ErrorExit", (char*) ErrorExit, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "FlashCmdE", (char*) &FlashCmdE, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "FlashCmdS", (char*) &FlashCmdS, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "FreeMemory", (char*) FreeMemory, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "InitMemArray", (char*) InitMemArray, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "LUtempvv", (char*) &LUtempvv, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "MV64360_regs_dump", (char*) MV64360_regs_dump, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "MoveMemory", (char*) MoveMemory, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "Nbase__9streambuf", (char*) Nbase__9streambuf, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "Now", (char*) Now, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "RemoveMemArray", (char*) RemoveMemArray, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "ReportError", (char*) ReportError, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "RoundInternalFPF", (char*) RoundInternalFPF, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "SetupCPUEmFloatArrays", (char*) SetupCPUEmFloatArrays, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "StartStopwatch", (char*) StartStopwatch, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "StopStopwatch", (char*) StopStopwatch, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "TestIntConnect", (char*) TestIntConnect, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "TicksToFracSecs", (char*) TicksToFracSecs, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "TicksToSecs", (char*) TicksToSecs, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "abs_randwc", (char*) abs_randwc, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "average_error", (char*) &average_error, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "avg_out_error", (char*) &avg_out_error, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "b", (char*) b, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "bad__C3ios", (char*) bad__C3ios, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "bandwidth", (char*) bandwidth, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "bandwidth_n", (char*) bandwidth_n, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "bandwidth_val", (char*) bandwidth_val, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "bindex", (char*) &bindex, 0, SYM_GLOBAL | SYM_DATA},
        ...
        {{NULL}, "bwMem", (char*) bwMem, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "bytes", (char*) bytes, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "compilername", (char*) &compilername, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "compilerversion", (char*) &compilerversion, 0, SYM_GLOBAL | SYM_DATA},
        ...
        {{NULL}, "context", (char*) context, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "cpy", (char*) cpy, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "dblprint", (char*) dblprint, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "doubleTest", (char*) doubleTest, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "fcp", (char*) fcp, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "frcEEPROMDummyWrite", (char*) frcEEPROMDummyWrite, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "frcEEPROMDummyWrite16", (char*) frcEEPROMDummyWrite16, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "frcI2CRead", (char*) frcI2CRead, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "frcI2CWrite", (char*) frcI2CWrite, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "frcI2cReset", (char*) frcI2cReset, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "frcLmbench", (char*) frcLmbench, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "frcRTCDummyWrite", (char*) frcRTCDummyWrite, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "frcTestbwMem", (char*) frcTestbwMem, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "frcTestgettimeofday", (char*) frcTestgettimeofday, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "frcTestlatMemRead", (char*) frcTestlatMemRead, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "frd", (char*) frd, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "ftestnames", (char*) &ftestnames, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "ftiming", (char*) &ftiming, 0, SYM_GLOBAL | SYM_BSS},
        ...
        {{NULL}, "funcpointer", (char*) &funcpointer, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "fwr", (char*) fwr, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "get_enough", (char*) get_enough, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "get_mem", (char*) get_mem, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "get_myaddress", (char*) get_myaddress, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "get_n", (char*) get_n, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "get_results", (char*) get_results, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "getpagesize_lmbench", (char*) getpagesize_lmbench, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "gettimeofday_lmbench", (char*) gettimeofday_lmbench, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "getw", (char*) getw, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "getwd", (char*) getwd, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "global_align", (char*) &global_align, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "global_allstats", (char*) &global_allstats, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "global_assignstruct", (char*) &global_assignstruct, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "global_bitopstruct", (char*) &global_bitopstruct, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "global_custrun", (char*) &global_custrun, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "global_emfloatstruct", (char*) &global_emfloatstruct, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "global_fourierstruct", (char*) &global_fourierstruct, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "global_fstruct", (char*) &global_fstruct, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "global_huffstruct", (char*) &global_huffstruct, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "global_ideastruct", (char*) &global_ideastruct, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "global_lustruct", (char*) &global_lustruct, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "global_min_seconds", (char*) &global_min_seconds, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "global_min_ticks", (char*) &global_min_ticks, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "global_nnetstruct", (char*) &global_nnetstruct, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "global_numsortstruct", (char*) &global_numsortstruct, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "global_ofile", (char*) &global_ofile, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "global_ofile_name", (char*) &global_ofile_name, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "global_strsortstruct", (char*) &global_strsortstruct, 0, SYM_GLOBAL | SYM_BSS},
        ...
        {{NULL}, "in_pats", (char*) &in_pats, 0, SYM_GLOBAL | SYM_DATA},
        ...
        {{NULL}, "inpath", (char*) &inpath, 0, SYM_GLOBAL | SYM_DATA},
        ...
        {{NULL}, "insertinit", (char*) insertinit, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "insertsort", (char*) insertsort, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "iteration_count", (char*) &iteration_count, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "kb", (char*) kb, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "l_overhead", (char*) l_overhead, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "labs", (char*) labs, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "last", (char*) last, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "latMemRead", (char*) latMemRead, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "lat_h", (char*) lat_h, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "latency", (char*) latency, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "learned", (char*) &learned, 0, SYM_GLOBAL | SYM_BSS},
        ...
        {{NULL}, "lmbench_settime", (char*) lmbench_settime, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "loads", (char*) loads, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "loads_i", (char*) loads_i, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "lx_bindex", (char*) &lx_bindex, 0, SYM_GLOBAL | SYM_DATA},
        ...
        {{NULL}, "maxMove", (char*) &maxMove, 0, SYM_GLOBAL | SYM_DATA},
        ...
        {{NULL}, "mb", (char*) mb, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "mem_array", (char*) &mem_array, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "mem_array_ents", (char*) &mem_array_ents, 0, SYM_GLOBAL | SYM_BSS},
        ...
        {{NULL}, "micro", (char*) micro, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "micromb", (char*) micromb, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "mid_error", (char*) &mid_error, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "mid_out", (char*) &mid_out, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "mid_wt_change", (char*) &mid_wt_change, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "mid_wt_cum_change", (char*) &mid_wt_cum_change, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "mid_wts", (char*) &mid_wts, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "milli", (char*) milli, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "minMove", (char*) &minMove, 0, SYM_GLOBAL | SYM_DATA},
        ...
        {{NULL}, "morefds", (char*) morefds, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "nano", (char*) nano, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "nbench", (char*) nbench, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "numpasses", (char*) &numpasses, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "numpats", (char*) &numpats, 0, SYM_GLOBAL | SYM_BSS},
        ...
        {{NULL}, "outBuffer", (char*) &outBuffer, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "out_error", (char*) &out_error, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "out_out", (char*) &out_out, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "out_pats", (char*) &out_pats, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "out_waiting__9streambuf", (char*) out_waiting__9streambuf, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "out_wt_change", (char*) &out_wt_change, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "out_wt_cum_change", (char*) &out_wt_cum_change, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "out_wts", (char*) &out_wts, 0, SYM_GLOBAL | SYM_BSS},
        ...
        {{NULL}, "p64", (char*) p64, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "p64sz", (char*) p64sz, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "pIntf", (char*) &pIntf, 0, SYM_GLOBAL | SYM_BSS},
        ...
        {{NULL}, "paramnames", (char*) &paramnames, 0, SYM_GLOBAL | SYM_DATA},
        ...
        {{NULL}, "print_bytes", (char*) print_bytes, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "ptime", (char*) ptime, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "randnum", (char*) randnum, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "random", (char*) random, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "randwc", (char*) randwc, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "rd", (char*) rd, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "rdwr", (char*) rdwr, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "save_median", (char*) save_median, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "save_minimum", (char*) save_minimum, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "save_n", (char*) save_n, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "save_results", (char*) save_results, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "start", (char*) start, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "step", (char*) step, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "stop", (char*) stop, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "sysTimestampResetRtn", (char*) &sysTimestampResetRtn, 0, SYM_GLOBAL | SYM_DATA},
        ...
        {{NULL}, "sysname", (char*) &sysname, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "system", (char*) system, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "t_overhead", (char*) t_overhead, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "tbReset", (char*) tbReset, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "tbReset_lmbench", (char*) tbReset_lmbench, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "tbStart", (char*) &tbStart, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "tbStart_lm", (char*) &tbStart_lm, 0, SYM_GLOBAL | SYM_DATA},
        ...
        {{NULL}, "tests_to_do", (char*) &tests_to_do, 0, SYM_GLOBAL | SYM_BSS},
        ...
        {{NULL}, "timespent", (char*) timespent, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "timing", (char*) timing, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "tot_out_error", (char*) &tot_out_error, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "totalerrors", (char*) &totalerrors, 0, SYM_GLOBAL | SYM_DATA},
        {{NULL}, "touch", (char*) touch, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "tvdelta", (char*) tvdelta, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "tvsub", (char*) tvsub, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "use_int", (char*) use_int, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "use_pointer", (char*) use_pointer, 0, SYM_GLOBAL | SYM_TEXT},
        {{NULL}, "use_result_dummy", (char*) &use_result_dummy, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "usecs_spent", (char*) usecs_spent, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "wordcatarray", (char*) &wordcatarray, 0, SYM_GLOBAL | SYM_DATA},
        ...
        {{NULL}, "worst_error", (char*) &worst_error, 0, SYM_GLOBAL | SYM_BSS},
        {{NULL}, "wr", (char*) wr, 0, SYM_GLOBAL | SYM_TEXT},
        ...
        {{NULL}, "write_to_file", (char*) &write_to_file, 0, SYM_GLOBAL | SYM_BSS},
