...
#define DEFAULT_BOOT_LINE       \
       "mgi(0,0) clon10:$CODA/VXWORKS_ppc/bin/vx280 " \
       "e=129.57.34.187:FFFFFC00 " \
       "h=129.57.167.14 " \
       "g=129.57.32.1 " \
       "u=boiarino " \
       "f=0x20 " \
       "tn=croctest7 " \
       "s=$CODA/VXWORKS_ppc/bootscripts/boot_pmc1 "
*/
#define DEFAULT_BOOT_LINE       \
       "mgi(0,0) clon10:$CODA/VXWORKS_ppc/bin/vx280 " \
       "e=129.57.68.30:FFFFFF00 " \
       "h=129.57.68.21 " \
       "u=boiarino " \
       "f=0x20 " \
       "tn=croctest13 " \
       "s=$CODA/VXWORKS_ppc/bootscripts/boot_pmc1 "
/*
#define DEFAULT_BOOT_LINE0       \
       "mgi(0,0) clon10:$CODA/VXWORKS_ppc/bin/vx280dual " \
       "e=129.57.34.187:FFFFFC00 " \
       "h=129.57.167.14 " \
       "g=129.57.32.1 " \
       "u=boiarino " \
...
/*sergey: increase shared memory size from 32M to 128M*/
#define APP_SHMEM_SIZE       0x08000000/*0x02000000*/  /* Shared memory size for apps  */
...
*/
/*sergey*/
#define ROM_BASE_ADRS   0xa0000000/*0xfff00000*//* base address of ROM     */
...
#define CONSOLE_BAUD_RATE /*9600*/38400/*115200*/	/* Reconfigure default baud rate */
...
/*sergey: change bootline offsets to avoid overlaping with boot image*/
#ifdef  INCLUDE_FLASH
    #define  INCLUDE_FLASH_BOOTLINE 
#ifdef PMC280_DUAL_CPU
    #define   NV_BOOT_OFFSET_CPU0   0x100000/*0*/
    #define   NV_BOOT_OFFSET_CPU1   0x140000/*0x40000*/

    #undef   NV_BOOT_OFFSET
    #define  NV_BOOT_OFFSET  nvBootOffset   /* User defined */
#else
    #undef   NV_BOOT_OFFSET
    #define  NV_BOOT_OFFSET  0x100000/*0*/   /* User defined */
#endif /* PMC280_DUAL_CPU */
#endif
