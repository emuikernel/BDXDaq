...
/* globals */
UINT32 sdramSize;                /* SDRAM calculated size   */
...
/* Little to Big endian conversion macros */
    ...
    #define GT_LONG_SWAP(X)  ((l64)(X))
        ...
        #define GT_SHORT_SWAP(X) ((((X)&0xff)<<8) | (((X)&0xff00)>>8))
    #endif /* GT_SHORT_SWAP */
    #ifndef GT_WORD_SWAP
    ...
    #endif /* GT_LONG_SWAP */
    #ifndef GT_WORD_SWAP_VPD
        #define GT_WORD_SWAP_VPD(X)  (X)
    #endif
#endif /* LE */
...
/* Read/Write to/from GT`s internal registers */
    ...
    #define GT_REG_READ(offset, pData)                                         \
            (*(pData) = GT_WORD_SWAP(*((volatile unsigned int *)               \
            (NONE_CACHEABLE(gtInternalRegBaseAddr) | (offset)))))
#endif /* GT_REG_READ */

#ifndef GTREGREAD
    #define GTREGREAD(offset)                                                  \
            (GT_WORD_SWAP(*((volatile unsigned int *)                          \
            (NONE_CACHEABLE(gtInternalRegBaseAddr) | (offset)))))
#endif /* GTREGREAD */
...
#ifndef GT_REG_READ_VPD /*  VPD BUG FIX */
   #define GT_REG_READ_VPD(offset, pData)					\
           (*(pData) = GT_WORD_SWAP_VPD(*((volatile unsigned int *)             \
            (NONE_CACHEABLE(gtInternalRegBaseAddr) | (offset))))) 
#endif /* VPD BUG FIX */ 

#ifndef GT_REG_WRITE_VPD /* VPD BUG FIX */
    #define GT_REG_WRITE_VPD(offset, data)                                     \
            ((*((volatile unsigned int *)                                      \
            (NONE_CACHEABLE(gtInternalRegBaseAddr) |                           \
            (offset)))) = GT_WORD_SWAP_VPD((data)))
#endif /* VPD BUG FIX */ 
...
/* Relevant ONLY for GNU powerpc-eabi compiler users */
int __eabi(void);
#endif /* __INCgtCoreh */
