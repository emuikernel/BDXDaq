...
*/
void 
SetupCPUEmFloatArrays (InternalFPF * abase,
		       InternalFPF * bbase,
		       InternalFPF * cbase,
		       ulong arraysize)
{
 ...
 */
...
#ifdef DEBUG
	{
		...
		{
		    i = j[k];
		    InternalFPFToString (outBuffer, abase + i);
		    printf ("%6ld: (%s) ", i, outBuffer);
		    switch (jtable[i % 16])
		    {
		    case 0:
			strcpy (outBuffer, "+");
		    ...
		    printf ("%s ", outBuffer);
		    InternalFPFToString (outBuffer, bbase + i);
		    printf ("(%s) = ", outBuffer);
		    InternalFPFToString (outBuffer, cbase + i);
		    printf ("%s\n", outBuffer);
		}
	    }
	}
...
*/
static void 
SetInternalFPFZero (InternalFPF * dest,
		    uchar sign)
{
    int i;			/* Index */
...
*/
static void 
SetInternalFPFInfinity (InternalFPF * dest,
			uchar sign)
{
    int i;			/* Index */
...
*/
static void 
SetInternalFPFNaN (InternalFPF * dest)
{
    int i;			/* Index */
...
*/
static void 
StickyShiftRightMant (InternalFPF * ptr,
		      int amount)
{
    int i;			/* Index */
...
*/
static void 
AddSubInternalFPF (uchar operation,
		   InternalFPF * x,
		   InternalFPF * y,
		   InternalFPF * z)
{
...
*/
static void 
MultiplyInternalFPF (InternalFPF * x,
		     InternalFPF * y,
		     InternalFPF * z)
{
    int i;
...
*/
static void 
DivideInternalFPF (InternalFPF * x,
		   InternalFPF * y,
		   InternalFPF * z)
{
    int i;
...
static void 
Int32ToInternalFPF (int32 mylong,
		    InternalFPF * dest)
{
    int i;			/* Index */
...
** NOTE: dest must point to a outBuffer big enough to hold the
