...
--------------------
02d,02oct01,bwa  added MSG_Q_ID msgQId to list of arguments of 
                 qJobGet()(SPR #20195)
02c,10sep01,bwa  Modified qJobPut() parameters
...
extern Q_JOB_NODE *	qJobGet (MSG_Q_ID msgQId, Q_JOB_HEAD *pQHead, 
				 int timeout);
...
extern int 		qJobInfo (Q_JOB_HEAD *pQHead, int nodeArray [],
				  int maxNodes);
extern STATUS 		qJobPut (MSG_Q_ID msgQId, Q_JOB_HEAD *pQHead,
						Q_JOB_NODE *pNode, int key);
