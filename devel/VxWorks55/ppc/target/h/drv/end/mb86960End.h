/* mb86960End.h -  Fujitsu MB86960 Ethernet Controller interface header */
...
--------------------
01b,20sep01,dat  Removing ANSI errors for diab compiler
01a,27feb99,db  created from target/h/drv/netif/if_fn.h
*/

#ifndef __INCmb86960h
#define __INCmb86960h
...
#define FN_DEV_NAME	"fn"
#define FN_DEV_NAME_LEN	3
...
#define MB86960_CRC_POLY	0xedb88320
...
#define MB86960_SPEED       10000000	/* 10BASE-T speed in bits/sec */
...
#define MB86960_RX_HDR_SIZ  sizeof(MB86960_RX_HDR)

#define MB86960_DATA_OFFSET (sizeof(u_short) + MB86960_RX_HDR_SIZ) 

typedef struct rx_frame 
    {
    u_short pad1;
    MB86960_RX_HDR  rxHdr;		/* header provided by chip */
    struct  ether_header enetHdr;        /* the Ethernet header */
    char data [ETHERMTU];               /* the data field */
    } MB86960_RX_FRAME;

#define MB86960_BUFSIZ (sizeof(struct rx_frame))

#define MB86960_FRAME_DATA_ADDR_GET(pFrame) \
	(pFrame = ((char *)(pFrame) + sizeof(UINT16) \
		+ sizeof(MB86960_RX_HDR)))

/* The definition of the driver control structure */

typedef struct mb86960_end_ctrl
    {
    END_OBJ     end;            /* The class we inherit from. */
    int         unit;           /* unit number */
    int         vector;         /* interrupt vector */
    long        flags;          /* Our local flags. */
    char *      devBaseAddr;    /* Base address of the device register set */
    SEM_ID	txSem;		/* transmitter semaphore */
    UCHAR       enetAddr[6];    /* ethernet address */
    CL_POOL_ID  pClPoolId;      /* Cluster Pool Id */
    } MB86960_END_CTRL;

#define MB86960_END_CTRL_SIZE	sizeof(MB86960_END_CTRL)
