/* mbcEnd.h - Motorola 68302fads End network interface header */
...
#define DEV_NAME		"mbc"	/* device interface name */
#define DEV_NAME_LEN		4	/* device name length */
