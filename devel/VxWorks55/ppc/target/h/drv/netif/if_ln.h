...
--------------------
01t,09nov01,dat  Adding obsolescence warnings to outdated drivers
01s,08apr97,spm  restored TMD_ERR #define needed for if_lnsgi driver
01r,26jan96,vin  modified for BSD44.
01q,22jun94,dzb  removed obsolete definitions.
...
#warning "if_ln driver is obsolete, please use ln7990End driver"
...
typedef struct lnIB
    ...
    char	lnIBPadr [6];	/* PADR: byte swapped ethernet physical addr */
...
typedef struct lnRMD
    {
    u_short	lnRMD0;		/* bits 15:00 of receive buf */
    u_short	lnRMD1;	        /* bits 23:16 of receive buf and status */
...
typedef struct lnTMD
    {
    u_short	lnTMD0;		/* bits 15:00 of transmit buf */
    u_short	lnTMD1;		/* bits 23:16 of transmit buf and status */
...
#define tbuf_hadr	lnTMD1
#define tbuf_stat	lnTMD1
#define	tbuf_bcnt	lnTMD2
#define tbuf_err	lnTMD3
