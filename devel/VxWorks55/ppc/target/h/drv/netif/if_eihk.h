/* if_eihk.h - Intel 82596 network interface header for hkv3500 */
...
01a,28apr97,map  created from if_ei.h ver 02h. word-align enetData;
                 use RBD in RFD. [SPR# 3511]
*/

#ifndef __INCif_eihkh
#define __INCif_eihkh

#ifdef __cplusplus
extern "C" {
#endif

#warning "if_eihk driver is obsolete, please use ei82596End driver"
...
typedef struct rbd              /* RBD - Receive Buffer Descriptor */
    {
    volatile UINT16	actualCnt;           /* size of real data */
    UINT16		reserved0;
    EI_LINK		lNext;              /* address of the next RBD */
    EI_LINK		pData;               /* address of a data buffer */
    volatile UINT16	size;                /* size of data buffer */
    UINT16		reserved1;
    } RBD;

/* RBD size field bit masks */    

#define RBD_EL		0x8000		     /* last in buffer list */
#define RBD_P		0x4000               /* prefetched */
