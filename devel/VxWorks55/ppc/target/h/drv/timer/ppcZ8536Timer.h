/* ppcZ8536Timer.h - zilog CIO (counter,timer,parallel i/o chip) */
...
--------------------
01c,13apr00,dat  added prototypes for driver entry points
01b,18jan99,sut  remove ZCIO_DD_OUT, and added ZCIO_DD_PORT_x marcos (SPR 23111)
01a,07nov95,kvk  created from version 01g of z8536.h for PPC.
*/
...
#ifndef __INCppcZ8536Timerh
#define __INCppcZ8536Timerh
...
#ifndef ZCIO_DD_PORT_A
#define ZCIO_DD_PORT_A     ((UINT8) ZERO)  /* OUTput bit */
#endif
    
#ifndef ZCIO_DD_PORT_B
#define ZCIO_DD_PORT_B     ((UINT8) ZERO)  /* OUTput bit */
#endif
    
    
#ifndef ZCIO_DD_PORT_C
#define ZCIO_DD_PORT_C     ((UINT8) ZERO)  /* OUTput bit */    
#endif
...
IMPORT	UINT	sysZ8536Init (void);
IMPORT	void	sysCioReset (volatile UINT8 * pCio);
IMPORT	void	sysClkIntCIO (void);

#else	/* __STDC__ */

IMPORT	UINT	sysZ8536Init ();
IMPORT	void	sysCioReset ();
IMPORT	void	sysClkIntCIO ();
