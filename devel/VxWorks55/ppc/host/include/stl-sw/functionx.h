...
#ifndef __SGI_STL_FUNCTION_X_H
#define __SGI_STL_FUNCTION_X_H
...
template <class Result>
class pointer_to_void_function : public unary_function<__void_tag,Result> {
protected:
    Result (*ptr)();
public:
...
class mem_fun_const_ref_t : public unary_function<const Class, Result> {
protected:
...
class mem_fun1_const_ref_t: public binary_function<const Class, Arg, Result> {
public:
protected:
