...
# if defined ( __STL_DEBUG )
  __rb_tree_const_iterator(const __safe_base* root, link_type x) : 
      __rb_tree_base_iterator(root,x) {}
...
#  endif
    ...
    static link_type __copy_aux(link_type x, link_type p);
    static void __erase(link_type x);
